...
class BetaTelemetryServiceConnectErrorCodeEnum(str, Enum):
    """BetaTelemetryServiceConnectError - code"""
...
class BetaTelemetryServiceConnectError(BaseModel):
    ...
    code: Optional[BetaTelemetryServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaTelemetryServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaTelemetryServiceConnectError.model_rebuild(raise_errors=False)
