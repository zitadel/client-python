...
class BetaAppServiceApplicationKey(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "applicationId", "projectId", "creationDate", "organizationId", "expirationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaAppServiceApplicationKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaAppServiceApplicationKey from a dict"""
        if obj is None:
            return None
