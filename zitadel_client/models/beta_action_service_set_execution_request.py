...
class BetaActionServiceSetExecutionRequest(BaseModel):
    """
    BetaActionServiceSetExecutionRequest
    """ # noqa: E501
    condition: Optional[BetaActionServiceCondition] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaActionServiceSetExecutionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaActionServiceSetExecutionRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "condition": BetaActionServiceCondition.from_dict(obj["condition"]) if obj.get("condition") is not None else None,
