...
class UserNameQuery(BaseModel):
    ...
    UserNameQuery
    """ # noqa: E501
    user_name_query: UserServiceUserNameQuery = Field(alias="userNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserNameQuery from a dict"""
        if obj is None:
            return None
