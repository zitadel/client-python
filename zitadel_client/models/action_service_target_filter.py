...
class ActionServiceTargetFilter(BaseModel):
    """
    ...
    target_id: Optional[StrictStr] = Field(
        default=None,
        alias="targetId",
        description="Defines the id of the target that needs to be part of the execution.",
    )
...
ActionServiceTargetFilter.model_rebuild(raise_errors=False)
