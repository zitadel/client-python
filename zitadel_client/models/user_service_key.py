...
class UserServiceKey(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(
        default=None,
        alias="userId",
        description="The unique identifier of the user the key belongs to.",
    )
    organization_id: Optional[StrictStr] = Field(
        default=None,
        alias="organizationId",
        description="The unique identifier of the organization the key belongs to.",
    )
...
UserServiceKey.model_rebuild(raise_errors=False)
