...
class UserServiceKey(BaseModel):
    """
    UserServiceKey
    """ # noqa: E501
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the user the key belongs to.", alias="userId")
    organization_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the organization the key belongs to.", alias="organizationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceKey from a dict"""
        if obj is None:
            return None
