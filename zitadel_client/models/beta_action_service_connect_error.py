...
class BetaActionServiceConnectErrorCodeEnum(str, Enum):
    """BetaActionServiceConnectError - code"""
...
class BetaActionServiceConnectError(BaseModel):
    ...
    code: Optional[BetaActionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaActionServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaActionServiceConnectError.model_rebuild(raise_errors=False)
