...
class SessionServiceGetSessionResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionServiceGetSessionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionServiceGetSessionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "session": SessionServiceSession.from_dict(obj["session"]) if obj.get("session") is not None else None
        })
        return _obj
