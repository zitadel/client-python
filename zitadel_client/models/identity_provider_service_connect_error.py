...
class IdentityProviderServiceConnectErrorCodeEnum(str, Enum):
    """IdentityProviderServiceConnectError - code"""
...
class IdentityProviderServiceConnectError(BaseModel):
    ...
    code: Optional[IdentityProviderServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[IdentityProviderServiceAny]] = Field(
        default=None,
        alias="details",
...
IdentityProviderServiceConnectError.model_rebuild(raise_errors=False)
