...
class LastNameQuery1(BaseModel):
    """
    LastNameQuery1
    """ # noqa: E501
    last_name_query: BetaUserServiceLastNameQuery = Field(alias="lastNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["lastNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LastNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LastNameQuery1 from a dict"""
        if obj is None:
            return None
