...
class StateFilter1(BaseModel):
    """
    StateFilter1
    """ # noqa: E501
    state_filter: BetaOrganizationServiceOrgStateFilter = Field(alias="stateFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["stateFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateFilter1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateFilter1 from a dict"""
        if obj is None:
            return None
