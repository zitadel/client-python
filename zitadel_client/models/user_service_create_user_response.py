...
class UserServiceCreateUserResponse(BaseModel):
    """
    UserServiceCreateUserResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the newly created user.")
    ...
    email_code: Optional[StrictStr] = Field(default=None, description="The email verification code if it was requested by setting the email verification to return_code.", alias="emailCode")
    phone_code: Optional[StrictStr] = Field(default=None, description="The phone verification code if it was requested by setting the phone verification to return_code.", alias="phoneCode")
    __properties: ClassVar[List[str]] = ["id", "creationDate", "emailCode", "phoneCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceCreateUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceCreateUserResponse from a dict"""
        if obj is None:
            return None
