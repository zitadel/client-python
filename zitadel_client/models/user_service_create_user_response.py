...
class UserServiceCreateUserResponse(BaseModel):
    ...
    email_code: Optional[StrictStr] = Field(
        default=None,
        alias="emailCode",
        description="The email verification code if it was requested by setting the email verification to return_code.",
    )
...
UserServiceCreateUserResponse.model_rebuild(raise_errors=False)
