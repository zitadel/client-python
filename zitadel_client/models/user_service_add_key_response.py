...
class UserServiceAddKeyResponse(BaseModel):
    """
    ...
    key_id: Optional[StrictStr] = Field(default=None, description="The keys ID.", alias="keyId")
    key_content: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="The key which is usable to authenticate against the API.", alias="keyContent")
    __properties: ClassVar[List[str]] = ["creationDate", "keyId", "keyContent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceAddKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceAddKeyResponse from a dict"""
        if obj is None:
            return None
