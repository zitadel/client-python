...
class OrganizationServiceOrganizationDomainQuery(BaseModel):
    """
    ...
    method: Optional[OrganizationServiceTextQueryMethod] = Field(
...
OrganizationServiceOrganizationDomainQuery.model_rebuild(raise_errors=False)
