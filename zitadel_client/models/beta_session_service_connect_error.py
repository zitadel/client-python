...
class BetaSessionServiceConnectErrorCodeEnum(str, Enum):
    """BetaSessionServiceConnectError - code"""
...
class BetaSessionServiceConnectError(BaseModel):
    ...
    code: Optional[BetaSessionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaSessionServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaSessionServiceConnectError.model_rebuild(raise_errors=False)
