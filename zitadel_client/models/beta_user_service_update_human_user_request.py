...
class BetaUserServiceUpdateHumanUserRequest(BaseModel):
    ...
    password: Optional[BetaUserServiceSetPassword] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceUpdateHumanUserRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceUpdateHumanUserRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "password": BetaUserServiceSetPassword.from_dict(obj["password"]) if obj.get("password") is not None else None
        })
        return _obj
