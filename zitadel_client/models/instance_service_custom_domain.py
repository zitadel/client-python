...
class InstanceServiceCustomDomain(BaseModel):
    ...
    """ # noqa: E501
    instance_id: Optional[StrictStr] = Field(default=None, description="InstanceID is the unique identifier of the instance the domain belongs to.", alias="instanceId")
    ...
    domain: Optional[StrictStr] = Field(default=None, description="Domain is the fully qualified domain name.  It must be unique across all instances in the system.")
    primary: Optional[StrictBool] = Field(default=None, description="Primary states whether this domain is the primary domain of the instance.  Each instance must have exactly one primary domain.  The primary domain is used for various purposes and acts as fallback  in those cases, e.g if no explicit domain is specified.")
    generated: Optional[StrictBool] = Field(default=None, description="Generate states whether this domain was auto-generated by the system.  Auto-generated domains follow a specific pattern and are created  when a new instance is created.  They cannot be deleted, but the primary domain can be changed  to a manually added domain.")
    __properties: ClassVar[List[str]] = ["instanceId", "creationDate", "domain", "primary", "generated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceServiceCustomDomain from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceServiceCustomDomain from a dict"""
        if obj is None:
            return None
