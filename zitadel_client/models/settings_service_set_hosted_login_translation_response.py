...
class SettingsServiceSetHostedLoginTranslationResponse(BaseModel):
    ...
    etag: Optional[StrictStr] = Field(
        default=None,
        alias="etag",
        description="hash of the saved translation. Valid only when ignore_inheritance = true",
    )
...
SettingsServiceSetHostedLoginTranslationResponse.model_rebuild(raise_errors=False)
