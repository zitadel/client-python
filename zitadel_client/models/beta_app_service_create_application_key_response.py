...
class BetaAppServiceCreateApplicationKeyResponse(BaseModel):
    """
    ...
    key_details: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="keyDetails")
    __properties: ClassVar[List[str]] = ["id", "creationDate", "keyDetails"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaAppServiceCreateApplicationKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaAppServiceCreateApplicationKeyResponse from a dict"""
        if obj is None:
            return None
