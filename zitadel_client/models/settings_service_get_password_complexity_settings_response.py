...
class SettingsServiceGetPasswordComplexitySettingsResponse(BaseModel):
    ...
    details: Optional[SettingsServiceDetails] = Field(default=None, alias="details")
    settings: Optional[SettingsServicePasswordComplexitySettings] = Field(
...
SettingsServiceGetPasswordComplexitySettingsResponse.model_rebuild(raise_errors=False)
