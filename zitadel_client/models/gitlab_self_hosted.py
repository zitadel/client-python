...
class GitlabSelfHosted(BaseModel):
    """
    GitlabSelfHosted
    """ # noqa: E501
    gitlab_self_hosted: IdentityProviderServiceGitLabSelfHostedConfig = Field(alias="gitlabSelfHosted")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitlabSelfHosted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitlabSelfHosted from a dict"""
        if obj is None:
            return None
