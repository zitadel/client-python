...
class ActionServicePublicKey(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(
        default=None,
        alias="keyId",
        description="KeyID is the unique identifier of the public key.  It's also used as the `kid` field in the JWE header when the payload type is set to `PAYLOAD_TYPE_JWE`.",
    )
    ...
    fingerprint: Optional[StrictStr] = Field(
        default=None,
        alias="fingerprint",
        description="Fingerprint is the fingerprint of the public key. It's prefixed with the hashing algorithm used  and base64 encoded without padding, e.g. `SHA256:STqK+Sd4qgdu+UjiwI8NBjOD6P7UqQ42EZYIdySEyTw`.  The fingerprint can be used to easily compare the public key with other sources.",
    )
    expiration_date: Optional[AwareDatetime] = Field(
        default=None,
...
ActionServicePublicKey.model_rebuild(raise_errors=False)
