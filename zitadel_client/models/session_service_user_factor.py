...
class SessionServiceUserFactor(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None,
        alias="id",
        description="The unique identifier of the user that was verified.",
    )
    login_name: Optional[StrictStr] = Field(
        default=None,
        alias="loginName",
        description="The login name of the user that was verified.",
    )
    display_name: Optional[StrictStr] = Field(
        default=None,
        alias="displayName",
        description="The display name of the user that was verified.",
    )
...
SessionServiceUserFactor.model_rebuild(raise_errors=False)
