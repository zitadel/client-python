...
class IdpIntent(BaseModel):
    """
    IdpIntent
    """ # noqa: E501
    idp_intent: UserServiceIDPIntent = Field(alias="idpIntent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdpIntent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdpIntent from a dict"""
        if obj is None:
            return None
