...
class BetaAppServiceUpdateAPIApplicationConfigurationRequest(BaseModel):
    ...
    auth_method_type: Optional[BetaAppServiceAPIAuthMethodType] = Field(
...
BetaAppServiceUpdateAPIApplicationConfigurationRequest.model_rebuild(raise_errors=False)
