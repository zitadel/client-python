...
class UserNameQuery1(BaseModel):
    """
    UserNameQuery1
    """ # noqa: E501
    user_name_query: BetaUserServiceUserNameQuery = Field(alias="userNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserNameQuery1 from a dict"""
        if obj is None:
            return None
