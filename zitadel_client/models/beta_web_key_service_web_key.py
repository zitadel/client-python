...
class BetaWebKeyServiceWebKey(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the key.")
    ...
    state: Optional[BetaWebKeyServiceState] = None
    ecdsa: Optional[BetaWebKeyServiceECDSA] = None
    ed25519: Optional[Dict[str, Any]] = None
    rsa: Optional[BetaWebKeyServiceRSA] = None
    __properties: ClassVar[List[str]] = ["id", "creationDate", "changeDate", "state", "ecdsa", "ed25519", "rsa"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaWebKeyServiceWebKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaWebKeyServiceWebKey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "ecdsa": BetaWebKeyServiceECDSA.from_dict(obj["ecdsa"]) if obj.get("ecdsa") is not None else None,
            "ed25519": obj.get("ed25519"),
            "rsa": BetaWebKeyServiceRSA.from_dict(obj["rsa"]) if obj.get("rsa") is not None else None
        })
        return _obj
