...
class SendCode2(BaseModel):
    """
    SendCode2
    """ # noqa: E501
    send_code: UserServiceSendEmailVerificationCode = Field(alias="sendCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendCode2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendCode2 from a dict"""
        if obj is None:
            return None
