...
class SAMLServiceConnectErrorCodeEnum(str, Enum):
    """SAMLServiceConnectError - code"""
...
class SAMLServiceConnectError(BaseModel):
    ...
    code: Optional[SAMLServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[SAMLServiceAny]] = Field(
        default=None,
        alias="details",
