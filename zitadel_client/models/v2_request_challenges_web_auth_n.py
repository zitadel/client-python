...
class V2RequestChallengesWebAuthN(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2RequestChallengesWebAuthN from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2RequestChallengesWebAuthN from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "userVerificationRequirement": obj.get("userVerificationRequirement") if obj.get("userVerificationRequirement") is not None else V2UserVerificationRequirement.USER_VERIFICATION_REQUIREMENT_UNSPECIFIED
        })
