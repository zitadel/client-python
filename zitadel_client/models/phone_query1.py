...
class PhoneQuery1(BaseModel):
    """
    PhoneQuery1
    """ # noqa: E501
    phone_query: BetaUserServicePhoneQuery = Field(alias="phoneQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["phoneQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhoneQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhoneQuery1 from a dict"""
        if obj is None:
            return None
