...
class UserServiceCreateInviteCodeRequest(BaseModel):
    ...
    send_code: Optional[UserServiceSendInviteCode] = Field(default=None, alias="sendCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceCreateInviteCodeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceCreateInviteCodeRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sendCode": UserServiceSendInviteCode.from_dict(obj["sendCode"]) if obj.get("sendCode") is not None else None
        })
        return _obj
