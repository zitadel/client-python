...
class BetaOrganizationServiceCreateOrganizationResponse(BaseModel):
    ...
    organization_admins: Optional[List[BetaOrganizationServiceOrganizationAdmin]] = (
        Field(
            default=None,
            alias="organizationAdmins",
            description="The admins created/assigned for the Organization",
        )
    )
...
BetaOrganizationServiceCreateOrganizationResponse.model_rebuild(raise_errors=False)
