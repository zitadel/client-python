...
class BetaTelemetryServiceInstanceInformation(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, alias="id", description="The unique identifier of the instance."
    )
    domains: Optional[List[StrictStr]] = Field(
        default=None,
        alias="domains",
        description="The custom domains (incl. generated ones) of the instance.",
    )
...
BetaTelemetryServiceInstanceInformation.model_rebuild(raise_errors=False)
