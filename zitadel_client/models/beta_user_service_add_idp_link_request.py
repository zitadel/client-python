...
class BetaUserServiceAddIDPLinkRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceAddIDPLinkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceAddIDPLinkRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "idpLink": BetaUserServiceIDPLink.from_dict(obj["idpLink"]) if obj.get("idpLink") is not None else None
        })
        return _obj
