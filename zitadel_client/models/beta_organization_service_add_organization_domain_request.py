...
class BetaOrganizationServiceAddOrganizationDomainRequest(BaseModel):
    """
    ...
    organization_id: Optional[StrictStr] = Field(
        ...
        description="Organization Id for the Organization for which the domain is to be added to.",
    )
    domain: Optional[StrictStr] = Field(
        default=None,
        alias="domain",
        description="The domain you want to add to the organization.",
    )
...
BetaOrganizationServiceAddOrganizationDomainRequest.model_rebuild(raise_errors=False)
