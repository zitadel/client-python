...
class ApplicationServiceGenerateClientSecretResponse(BaseModel):
    """
    ApplicationServiceGenerateClientSecretResponse
    """ # noqa: E501
    client_secret: Optional[StrictStr] = Field(default=None, description="The newly generated client secret. It must be stored safely, as it will not be possible to retrieve it again.  A new client secret can be generated using this endpoint.", alias="clientSecret")
    ...
    __properties: ClassVar[List[str]] = ["clientSecret", "creationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationServiceGenerateClientSecretResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationServiceGenerateClientSecretResponse from a dict"""
        if obj is None:
            return None
