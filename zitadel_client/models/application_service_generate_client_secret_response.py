...
class ApplicationServiceGenerateClientSecretResponse(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(
        default=None,
        alias="clientSecret",
        description="The newly generated client secret. It must be stored safely, as it will not be possible to retrieve it again.  A new client secret can be generated using this endpoint.",
    )
...
ApplicationServiceGenerateClientSecretResponse.model_rebuild(raise_errors=False)
