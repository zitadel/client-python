...
class BetaActionServiceResponseExecution(BaseModel):
    ...
    method: Optional[StrictStr] = Field(
        default=None, alias="method", description="GRPC-method as condition."
    )
    service: Optional[StrictStr] = Field(
        default=None, alias="service", description="GRPC-service as condition."
    )
...
BetaActionServiceResponseExecution.model_rebuild(raise_errors=False)
