...
class BetaUserServiceVerifyPasskeyRegistrationRequest(BaseModel):
    ...
    public_key_credential: Optional[Dict[str, object]] = Field(
        default=None,
        alias="publicKeyCredential",
...
BetaUserServiceVerifyPasskeyRegistrationRequest.model_rebuild(raise_errors=False)
