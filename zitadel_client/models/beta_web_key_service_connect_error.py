...
class BetaWebKeyServiceConnectErrorCodeEnum(str, Enum):
    """BetaWebKeyServiceConnectError - code"""
...
class BetaWebKeyServiceConnectError(BaseModel):
    ...
    code: Optional[BetaWebKeyServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaWebKeyServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaWebKeyServiceConnectError.model_rebuild(raise_errors=False)
