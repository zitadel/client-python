...
class IdsQuery1(BaseModel):
    """
    IdsQuery1
    """ # noqa: E501
    ids_query: SessionServiceIDsQuery = Field(alias="idsQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["idsQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdsQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdsQuery1 from a dict"""
        if obj is None:
            return None
