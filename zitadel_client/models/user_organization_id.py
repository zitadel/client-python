...
class UserOrganizationId(BaseModel):
    ...
    UserOrganizationId
    """ # noqa: E501
    user_organization_id: BetaInternalPermissionServiceIDFilter = Field(alias="userOrganizationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserOrganizationId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserOrganizationId from a dict"""
        if obj is None:
            return None
