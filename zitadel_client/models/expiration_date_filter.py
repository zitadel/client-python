...
class ExpirationDateFilter(BaseModel):
    """
    ExpirationDateFilter
    """ # noqa: E501
    expiration_date_filter: UserServiceTimestampFilter = Field(alias="expirationDateFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expirationDateFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpirationDateFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpirationDateFilter from a dict"""
        if obj is None:
            return None
