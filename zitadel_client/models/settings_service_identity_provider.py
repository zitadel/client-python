...
class SettingsServiceIdentityProvider(BaseModel):
    """
    ...
    type: Optional[SettingsServiceIdentityProviderType] = Field(
        default=None, alias="type"
    )
    options: Optional[SettingsServiceOptions] = Field(default=None, alias="options")
...
SettingsServiceIdentityProvider.model_rebuild(raise_errors=False)
