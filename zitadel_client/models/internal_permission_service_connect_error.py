...
class InternalPermissionServiceConnectErrorCodeEnum(str, Enum):
    """InternalPermissionServiceConnectError - code"""
...
class InternalPermissionServiceConnectError(BaseModel):
    ...
    code: Optional[InternalPermissionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[InternalPermissionServiceAny]] = Field(
        default=None,
        alias="details",
...
InternalPermissionServiceConnectError.model_rebuild(raise_errors=False)
