...
class SendLink1(BaseModel):
    """
    SendLink1
    """ # noqa: E501
    send_link: UserServiceSendPasswordResetLink = Field(alias="sendLink")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendLink1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendLink1 from a dict"""
        if obj is None:
            return None
