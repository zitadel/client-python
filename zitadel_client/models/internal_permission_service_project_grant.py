...
class InternalPermissionServiceProjectGrant(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(
        default=None,
        alias="projectId",
        description="ProjectID is the unique identifier of the project the project grant belongs to.",
    )
...
InternalPermissionServiceProjectGrant.model_rebuild(raise_errors=False)
