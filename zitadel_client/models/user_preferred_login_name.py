...
class UserPreferredLoginName(BaseModel):
    """
    UserPreferredLoginName
    """ # noqa: E501
    user_preferred_login_name: BetaInternalPermissionServiceUserPreferredLoginNameFilter = Field(alias="userPreferredLoginName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userPreferredLoginName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserPreferredLoginName from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserPreferredLoginName from a dict"""
        if obj is None:
            return None
