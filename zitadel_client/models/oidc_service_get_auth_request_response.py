...
class OIDCServiceGetAuthRequestResponse(BaseModel):
    """
    OIDCServiceGetAuthRequestResponse
    """

    auth_request: Optional[OIDCServiceAuthRequest] = Field(
...
OIDCServiceGetAuthRequestResponse.model_rebuild(raise_errors=False)
