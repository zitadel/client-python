...
class SAMLServiceSAMLRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the created SAMLRequest.")
    ...
    issuer: Optional[StrictStr] = Field(default=None, description="SAML entityID of the application that created the SAMLRequest.")
    assertion_consumer_service: Optional[StrictStr] = Field(default=None, description="URL which points back to the assertion consumer service of the application that created the SAMLRequest.", alias="assertionConsumerService")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SAMLServiceSAMLRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SAMLServiceSAMLRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "assertionConsumerService": obj.get("assertionConsumerService"),
