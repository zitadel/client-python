...
class SAMLServiceSAMLRequest(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, alias="id", description="ID of the created SAMLRequest."
    )
    ...
    assertion_consumer_service: Optional[StrictStr] = Field(
        default=None,
        alias="assertionConsumerService",
        description="URL which points back to the assertion consumer service of the application that created the SAMLRequest.",
    )
    relay_state: Optional[StrictStr] = Field(
        default=None,
        alias="relayState",
        description="RelayState provided by the application for the request.",
    )
    binding: Optional[StrictStr] = Field(
        default=None,
        alias="binding",
...
SAMLServiceSAMLRequest.model_rebuild(raise_errors=False)
