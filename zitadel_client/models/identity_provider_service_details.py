...
class IdentityProviderServiceDetails(BaseModel):
    ...
    sequence: Optional[object] = Field(
        default=None,
        alias="sequence",
        description="sequence represents the order of events. It's always counting   on read: the sequence of the last event reduced by the projection   on manipulation: the timestamp of the event(s) added by the manipulation",
    )
    ...
    resource_owner: Optional[StrictStr] = Field(
        default=None,
        alias="resourceOwner",
...
IdentityProviderServiceDetails.model_rebuild(raise_errors=False)
