...
class KeyIdFilter(BaseModel):
    """
    KeyIdFilter
    """ # noqa: E501
    key_id_filter: UserServiceIDFilter = Field(alias="keyIdFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["keyIdFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeyIdFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeyIdFilter from a dict"""
        if obj is None:
            return None
