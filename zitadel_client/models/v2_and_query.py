...
class V2AndQuery(BaseModel):
    ...
    """ # noqa: E501
    queries: Optional[List[V2SearchQuery1]] = Field(default=None, description="the sub queries to 'AND'")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2AndQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2AndQuery from a dict"""
        if obj is None:
            return None
