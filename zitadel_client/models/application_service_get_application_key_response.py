...
class ApplicationServiceGetApplicationKeyResponse(BaseModel):
    """
    ApplicationServiceGetApplicationKeyResponse
    """ # noqa: E501
    key_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the application key.", alias="keyId")
    ...
    __properties: ClassVar[List[str]] = ["keyId", "creationDate", "expirationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationServiceGetApplicationKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationServiceGetApplicationKeyResponse from a dict"""
        if obj is None:
            return None
