...
class SessionServiceIDsQuery(BaseModel):
    ...
    ids: Optional[List[StrictStr]] = Field(
        default=None,
        alias="ids",
        description="List of session IDs to search for.  If multiple IDs are provided, sessions matching any of the IDs will be returned.",
    )
...
SessionServiceIDsQuery.model_rebuild(raise_errors=False)
