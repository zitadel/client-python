...
class UserAgentQuery(BaseModel):
    """
    UserAgentQuery
    """ # noqa: E501
    user_agent_query: SessionServiceUserAgentQuery = Field(alias="userAgentQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userAgentQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAgentQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAgentQuery from a dict"""
        if obj is None:
            return None
