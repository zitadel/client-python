...
class BetaUserServiceUpdateHumanUserResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["details", "emailCode", "phoneCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceUpdateHumanUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceUpdateHumanUserResponse from a dict"""
        if obj is None:
            return None
