...
class BetaActionServiceListExecutionFunctionsResponse(BaseModel):
    ...
    functions: Optional[List[StrictStr]] = Field(
        default=None, alias="functions", description="All available methods"
    )
...
BetaActionServiceListExecutionFunctionsResponse.model_rebuild(raise_errors=False)
