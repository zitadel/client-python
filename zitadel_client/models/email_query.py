...
class EmailQuery(BaseModel):
    ...
    EmailQuery
    """ # noqa: E501
    email_query: UserServiceEmailQuery = Field(alias="emailQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailQuery from a dict"""
        if obj is None:
            return None
