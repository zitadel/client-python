...
class BetaUserServiceSetPassword(BaseModel):
    ...
    """ # noqa: E501
    hashed_password: BetaUserServiceHashedPassword = Field(alias="hashedPassword")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceSetPassword from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceSetPassword from a dict"""
        if obj is None:
            return None
