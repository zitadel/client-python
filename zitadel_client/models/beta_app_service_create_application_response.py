...
class BetaAppServiceCreateApplicationResponse(BaseModel):
    ...
    api_response: Optional[BetaAppServiceCreateAPIApplicationResponse] = Field(
        default=None, alias="apiResponse"
    )
    oidc_response: Optional[BetaAppServiceCreateOIDCApplicationResponse] = Field(
        default=None, alias="oidcResponse"
    )
    saml_response: Optional[object] = Field(default=None, alias="samlResponse")
...
BetaAppServiceCreateApplicationResponse.model_rebuild(raise_errors=False)
