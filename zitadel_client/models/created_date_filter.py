...
class CreatedDateFilter(BaseModel):
    """
    CreatedDateFilter
    """ # noqa: E501
    created_date_filter: UserServiceTimestampFilter = Field(alias="createdDateFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdDateFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatedDateFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatedDateFilter from a dict"""
        if obj is None:
            return None
