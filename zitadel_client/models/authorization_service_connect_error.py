...
class AuthorizationServiceConnectErrorCodeEnum(str, Enum):
    """AuthorizationServiceConnectError - code"""
...
class AuthorizationServiceConnectError(BaseModel):
    ...
    code: Optional[AuthorizationServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[AuthorizationServiceAny]] = Field(
        default=None,
        alias="details",
...
AuthorizationServiceConnectError.model_rebuild(raise_errors=False)
