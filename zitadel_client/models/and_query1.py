...
class AndQuery1(BaseModel):
    """
    AndQuery1
    """ # noqa: E501
    and_query: BetaUserServiceAndQuery = Field(alias="andQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["andQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndQuery1 from a dict"""
        if obj is None:
            return None
...
AndQuery1.model_rebuild(raise_errors=False)
