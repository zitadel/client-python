...
class WebKeyServiceConnectErrorCodeEnum(str, Enum):
    """WebKeyServiceConnectError - code"""
...
class WebKeyServiceConnectError(BaseModel):
    ...
    code: Optional[WebKeyServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[WebKeyServiceAny]] = Field(
        default=None,
        alias="details",
...
WebKeyServiceConnectError.model_rebuild(raise_errors=False)
