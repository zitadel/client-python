...
class BetaProjectServiceConnectErrorCodeEnum(str, Enum):
    """BetaProjectServiceConnectError - code"""
...
class BetaProjectServiceConnectError(BaseModel):
    ...
    code: Optional[BetaProjectServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaProjectServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaProjectServiceConnectError.model_rebuild(raise_errors=False)
