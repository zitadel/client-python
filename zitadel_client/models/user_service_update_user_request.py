...
class UserServiceUpdateUserRequest(BaseModel):
    ...
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="The user id is the users unique identifier in the instance.  It can't be changed.", alias="userId")
    username: Optional[StrictStr] = Field(default=None, description="Set a new username that is unique within the instance.  Beware that active tokens and sessions are invalidated when the username is changed.")
    human: Optional[UserServiceHuman] = None
    machine: Optional[UserServiceMachine] = None
    __properties: ClassVar[List[str]] = ["userId", "username", "human", "machine"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceUpdateUserRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceUpdateUserRequest from a dict"""
        if obj is None:
            return None
