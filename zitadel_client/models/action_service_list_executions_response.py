...
class ActionServiceListExecutionsResponse(BaseModel):
    """
    ...
    executions: Optional[List[ActionServiceExecution]] = Field(
        default=None,
        alias="executions",
        description="List of all executions matching the query.",
    )
