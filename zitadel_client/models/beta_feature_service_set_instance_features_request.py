...
class BetaFeatureServiceSetInstanceFeaturesRequest(BaseModel):
    ...
    def oidc_token_exchange_warn_deprecated(cls, value: Any) -> Any:
        ...
        if value is not None:
            warnings.warn(
                "field 'oidc_token_exchange' on BetaFeatureServiceSetInstanceFeaturesRequest is deprecated",
                DeprecationWarning,
                stacklevel=2,
            )
        return value
...
BetaFeatureServiceSetInstanceFeaturesRequest.model_rebuild(raise_errors=False)
