...
class SessionServiceSearchQuery(BaseModel):
    ...
    expiration_date_query: Optional[SessionServiceExpirationDateQuery] = Field(default=None, alias="expirationDateQuery")
    ...
    __properties: ClassVar[List[str]] = ["creationDateQuery", "creatorQuery", "expirationDateQuery", "idsQuery", "userAgentQuery", "userIdQuery"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of expiration_date_query
        if self.expiration_date_query:
            _dict['expirationDateQuery'] = self.expiration_date_query.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expirationDateQuery": SessionServiceExpirationDateQuery.from_dict(obj["expirationDateQuery"]) if obj.get("expirationDateQuery") is not None else None,
