...
class BetaProjectServiceProjectRole(BaseModel):
    ...
    key: Optional[StrictStr] = Field(
        default=None, alias="key", description="Key of the project role."
    )
    ...
    display_name: Optional[StrictStr] = Field(
        default=None,
        alias="displayName",
        description="Display name of the project role.",
    )
    group: Optional[StrictStr] = Field(
        default=None, alias="group", description="Group of the project role."
    )
...
BetaProjectServiceProjectRole.model_rebuild(raise_errors=False)
