...
class ProjectServiceCreateProjectResponse(BaseModel):
    """
    ProjectServiceCreateProjectResponse
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, description="ProjectID is the unique identifier of the newly created project.", alias="projectId")
    ...
    __properties: ClassVar[List[str]] = ["projectId", "creationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectServiceCreateProjectResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectServiceCreateProjectResponse from a dict"""
        if obj is None:
            return None
