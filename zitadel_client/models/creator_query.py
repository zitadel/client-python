...
class CreatorQuery(BaseModel):
    ...
    CreatorQuery
    """ # noqa: E501
    creator_query: SessionServiceCreatorQuery = Field(alias="creatorQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creatorQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatorQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatorQuery from a dict"""
        if obj is None:
            return None
