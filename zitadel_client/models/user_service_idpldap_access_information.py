...
class UserServiceIDPLDAPAccessInformation(BaseModel):
    """
    UserServiceIDPLDAPAccessInformation
    """ # noqa: E501
    attributes: Optional[Dict[str, UserServiceValue]] = Field(default=None, description="`Struct` represents a structured data value, consisting of fields  which map to dynamically typed values. In some languages, `Struct`  might be supported by a native representation. For example, in  scripting languages like JS a struct is represented as an  object. The details of that representation are described together  with the proto support for the language.   The JSON representation for `Struct` is JSON object.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceIDPLDAPAccessInformation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceIDPLDAPAccessInformation from a dict"""
        if obj is None:
            return None
