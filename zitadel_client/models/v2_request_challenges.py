...
class V2RequestChallenges(BaseModel):
    ...
    V2RequestChallenges
    """ # noqa: E501
    web_auth_n: Optional[V2RequestChallengesWebAuthN] = Field(default=None, alias="webAuthN")
    otp_sms: Optional[RequestChallengesOTPSMS] = Field(default=None, alias="otpSms")
    otp_email: Optional[RequestChallengesOTPEmail] = Field(default=None, alias="otpEmail")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2RequestChallenges from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2RequestChallenges from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "webAuthN": V2RequestChallengesWebAuthN.from_dict(obj["webAuthN"]) if obj.get("webAuthN") is not None else None,
            "otpSms": RequestChallengesOTPSMS.from_dict(obj["otpSms"]) if obj.get("otpSms") is not None else None,
            "otpEmail": RequestChallengesOTPEmail.from_dict(obj["otpEmail"]) if obj.get("otpEmail") is not None else None
        })
