...
class V2LoginSettings(BaseModel):
    ...
    passkeys_type: Optional[V2PasskeysType] = Field(default=V2PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED, alias="passkeysType")
    ...
    second_factors: Optional[List[V2SecondFactorType]] = Field(default=None, alias="secondFactors")
    multi_factors: Optional[List[V2MultiFactorType]] = Field(default=None, alias="multiFactors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2LoginSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2LoginSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passkeysType": obj.get("passkeysType") if obj.get("passkeysType") is not None else V2PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED,
