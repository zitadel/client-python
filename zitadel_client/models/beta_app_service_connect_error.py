...
class BetaAppServiceConnectErrorCodeEnum(str, Enum):
    """BetaAppServiceConnectError - code"""
...
class BetaAppServiceConnectError(BaseModel):
    ...
    code: Optional[BetaAppServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaAppServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaAppServiceConnectError.model_rebuild(raise_errors=False)
