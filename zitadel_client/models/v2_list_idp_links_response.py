...
class V2ListIDPLinksResponse(BaseModel):
    ...
    result: Optional[List[V2IDPLink]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2ListIDPLinksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2ListIDPLinksResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": [V2IDPLink.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
