...
class UserServicePersonalAccessToken(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(
        default=None,
        alias="userId",
        description="The unique identifier of the user the personal access token belongs to.",
    )
    organization_id: Optional[StrictStr] = Field(
        default=None,
        alias="organizationId",
        description="The unique identifier of the organization the personal access token belongs to.",
    )
...
UserServicePersonalAccessToken.model_rebuild(raise_errors=False)
