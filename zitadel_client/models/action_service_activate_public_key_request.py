...
class ActionServiceActivatePublicKeyRequest(BaseModel):
    ...
    target_id: Optional[StrictStr] = Field(
        default=None,
        alias="targetId",
        description="TargetID is the unique identifier of the target to activate the public key for.",
    )
    key_id: Optional[StrictStr] = Field(
        default=None,
        alias="keyId",
        description="KeyID is the unique identifier of the public key to activate.",
    )
...
ActionServiceActivatePublicKeyRequest.model_rebuild(raise_errors=False)
