...
class UserIdQuery(BaseModel):
    ...
    UserIdQuery
    """ # noqa: E501
    user_id_query: BetaSessionServiceUserIDQuery = Field(alias="userIdQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserIdQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserIdQuery from a dict"""
        if obj is None:
            return None
