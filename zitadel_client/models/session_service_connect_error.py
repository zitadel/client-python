...
class SessionServiceConnectErrorCodeEnum(str, Enum):
    """SessionServiceConnectError - code"""
...
class SessionServiceConnectError(BaseModel):
    ...
    code: Optional[SessionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[SessionServiceAny]] = Field(
        default=None,
        alias="details",
...
SessionServiceConnectError.model_rebuild(raise_errors=False)
