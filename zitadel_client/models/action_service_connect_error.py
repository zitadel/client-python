...
class ActionServiceConnectErrorCodeEnum(str, Enum):
    """ActionServiceConnectError - code"""
...
class ActionServiceConnectError(BaseModel):
    ...
    code: Optional[ActionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[ActionServiceAny]] = Field(
        default=None,
        alias="details",
...
ActionServiceConnectError.model_rebuild(raise_errors=False)
