...
class RoleKey(BaseModel):
    ...
    RoleKey
    """ # noqa: E501
    role_key: BetaAuthorizationServiceRoleKeyQuery = Field(alias="roleKey")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoleKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoleKey from a dict"""
        if obj is None:
            return None
