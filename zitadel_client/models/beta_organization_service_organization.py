...
class BetaOrganizationServiceOrganization(BaseModel):
    ...
    state: Optional[BetaOrganizationServiceOrgState] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "changedDate", "state", "name", "primaryDomain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaOrganizationServiceOrganization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaOrganizationServiceOrganization from a dict"""
        if obj is None:
            return None
