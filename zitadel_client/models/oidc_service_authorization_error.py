...
class OIDCServiceAuthorizationError(BaseModel):
    """
    OIDCServiceAuthorizationError
    """

    error: Optional[OIDCServiceErrorReason] = Field(default=None, alias="error")
...
OIDCServiceAuthorizationError.model_rebuild(raise_errors=False)
