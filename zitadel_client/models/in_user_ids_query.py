...
class InUserIdsQuery(BaseModel):
    """
    InUserIdsQuery
    """ # noqa: E501
    in_user_ids_query: UserServiceInUserIDQuery = Field(alias="inUserIdsQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InUserIdsQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InUserIdsQuery from a dict"""
        if obj is None:
            return None
