...
class InProjectIdsFilter(BaseModel):
    """
    InProjectIdsFilter
    """ # noqa: E501
    in_project_ids_filter: BetaProjectServiceInIDsFilter = Field(alias="inProjectIdsFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inProjectIdsFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InProjectIdsFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InProjectIdsFilter from a dict"""
        if obj is None:
            return None
