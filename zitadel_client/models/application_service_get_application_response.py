...
class ApplicationServiceGetApplicationResponse(BaseModel):
    ...
    application: Optional[ApplicationServiceApplication] = Field(
        default=None, alias="application"
    )
...
ApplicationServiceGetApplicationResponse.model_rebuild(raise_errors=False)
