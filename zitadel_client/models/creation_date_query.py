...
class CreationDateQuery(BaseModel):
    """
    CreationDateQuery
    """ # noqa: E501
    creation_date_query: BetaSessionServiceCreationDateQuery = Field(alias="creationDateQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creationDateQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreationDateQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreationDateQuery from a dict"""
        if obj is None:
            return None
