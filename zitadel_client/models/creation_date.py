...
class CreationDate(BaseModel):
    ...
    CreationDate
    """ # noqa: E501
    creation_date: BetaInternalPermissionServiceTimestampFilter = Field(alias="creationDate")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreationDate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreationDate from a dict"""
        if obj is None:
            return None
