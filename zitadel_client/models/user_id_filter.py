...
class UserIdFilter(BaseModel):
    ...
    UserIdFilter
    """ # noqa: E501
    user_id_filter: UserServiceIDFilter = Field(alias="userIdFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userIdFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserIdFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserIdFilter from a dict"""
        if obj is None:
            return None
