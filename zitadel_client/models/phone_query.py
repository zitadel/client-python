...
class PhoneQuery(BaseModel):
    ...
    PhoneQuery
    """ # noqa: E501
    phone_query: UserServicePhoneQuery = Field(alias="phoneQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhoneQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhoneQuery from a dict"""
        if obj is None:
            return None
