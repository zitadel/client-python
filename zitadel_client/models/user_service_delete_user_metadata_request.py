...
class UserServiceDeleteUserMetadataRequest(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(
        default=None,
        alias="userId",
        description="ID of the user which metadata is to be deleted is stored on.",
    )
    keys: Optional[List[StrictStr]] = Field(
        default=None,
        alias="keys",
        description="The keys for the user metadata to be deleted.",
    )
...
UserServiceDeleteUserMetadataRequest.model_rebuild(raise_errors=False)
