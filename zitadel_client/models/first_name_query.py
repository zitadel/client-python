...
class FirstNameQuery(BaseModel):
    """
    FirstNameQuery
    """ # noqa: E501
    first_name_query: UserServiceFirstNameQuery = Field(alias="firstNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FirstNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FirstNameQuery from a dict"""
        if obj is None:
            return None
