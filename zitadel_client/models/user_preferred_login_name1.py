...
class UserPreferredLoginName1(BaseModel):
    """
    UserPreferredLoginName1
    """ # noqa: E501
    user_preferred_login_name: BetaAuthorizationServiceUserPreferredLoginNameQuery = Field(alias="userPreferredLoginName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserPreferredLoginName1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserPreferredLoginName1 from a dict"""
        if obj is None:
            return None
