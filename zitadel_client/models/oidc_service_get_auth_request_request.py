...
class OIDCServiceGetAuthRequestRequest(BaseModel):
    """
    ...
    auth_request_id: Optional[StrictStr] = Field(
        default=None,
        alias="authRequestId",
        description="The ID of the Auth Request, as obtained from the redirect URL.",
    )
...
OIDCServiceGetAuthRequestRequest.model_rebuild(raise_errors=False)
