...
class UserServiceOrQuery(BaseModel):
    """
    Connect multiple sub-condition with and OR operator.
    """ # noqa: E501
    queries: Optional[List[UserServiceSearchQuery]] = Field(default=None, description="the sub queries to 'OR'")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceOrQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceOrQuery from a dict"""
        if obj is None:
            return None
...
UserServiceOrQuery.model_rebuild(raise_errors=False)
