...
class AndQuery(BaseModel):
    ...
    AndQuery
    """ # noqa: E501
    and_query: UserServiceAndQuery = Field(alias="andQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndQuery from a dict"""
        if obj is None:
            return None
...
AndQuery.model_rebuild(raise_errors=False)
