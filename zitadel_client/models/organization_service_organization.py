...
class OrganizationServiceOrganization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "details", "state", "name", "primaryDomain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationServiceOrganization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationServiceOrganization from a dict"""
        if obj is None:
            return None
