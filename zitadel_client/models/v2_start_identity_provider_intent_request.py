...
class V2StartIdentityProviderIntentRequest(BaseModel):
    ...
    urls: Optional[V2RedirectURLs] = None
    ldap: Optional[V2LDAPCredentials] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2StartIdentityProviderIntentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2StartIdentityProviderIntentRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "idpId": obj.get("idpId"),
            "urls": V2RedirectURLs.from_dict(obj["urls"]) if obj.get("urls") is not None else None,
            "ldap": V2LDAPCredentials.from_dict(obj["ldap"]) if obj.get("ldap") is not None else None
        })
