...
class ActionServiceExecution(BaseModel):
    """
    ActionServiceExecution
    """

    condition: Optional[ActionServiceCondition] = Field(default=None, alias="condition")
    ...
    targets: Optional[List[StrictStr]] = Field(
        default=None,
        alias="targets",
        description="Ordered list of targets called during the execution.  The order of the targets in this list defines the order of execution.  If one of the targets fails, depending on the target's type and settings,  the execution might be interrupted and the following targets will not be called.",
    )
...
ActionServiceExecution.model_rebuild(raise_errors=False)
