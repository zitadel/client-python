...
class BetaOrganizationServiceDeactivateOrganizationRequest(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None,
        alias="id",
        description="Organization Id for the Organization to be deactivated",
    )
...
BetaOrganizationServiceDeactivateOrganizationRequest.model_rebuild(raise_errors=False)
