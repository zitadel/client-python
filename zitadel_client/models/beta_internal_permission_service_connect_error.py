...
class BetaInternalPermissionServiceConnectErrorCodeEnum(str, Enum):
    """BetaInternalPermissionServiceConnectError - code"""
...
class BetaInternalPermissionServiceConnectError(BaseModel):
    ...
    code: Optional[BetaInternalPermissionServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaInternalPermissionServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaInternalPermissionServiceConnectError.model_rebuild(raise_errors=False)
