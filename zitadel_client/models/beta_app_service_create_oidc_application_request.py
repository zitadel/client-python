...
class BetaAppServiceCreateOIDCApplicationRequest(BaseModel):
    ...
    """ # noqa: E501
    redirect_uris: Optional[List[StrictStr]] = Field(default=None, description="Callback URI of the authorization request where the code or tokens will be sent to", alias="redirectUris")
    ...
    post_logout_redirect_uris: Optional[List[StrictStr]] = Field(default=None, description="ZITADEL will redirect to this link after a successful logout", alias="postLogoutRedirectUris")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaAppServiceCreateOIDCApplicationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaAppServiceCreateOIDCApplicationRequest from a dict"""
        if obj is None:
            return None
