...
class OrganizationIdQuery(BaseModel):
    """
    OrganizationIdQuery
    """ # noqa: E501
    organization_id_query: UserServiceOrganizationIdQuery = Field(alias="organizationIdQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationIdQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationIdQuery from a dict"""
        if obj is None:
            return None
