...
class ActionServiceAddPublicKeyResponse(BaseModel):
    """
    ActionServiceAddPublicKeyResponse
    """ # noqa: E501
    key_id: Optional[StrictStr] = Field(default=None, description="The KeyID is the unique identifier of the newly added public key.  The ID is also used a `kid` in the JWT header for payload encryption.  This allows the target to identify the correct key to use for decryption.", alias="keyId")
    ...
    __properties: ClassVar[List[str]] = ["keyId", "creationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionServiceAddPublicKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionServiceAddPublicKeyResponse from a dict"""
        if obj is None:
            return None
