...
class ActionServiceAddPublicKeyResponse(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(
        default=None,
        alias="keyId",
        description="The KeyID is the unique identifier of the newly added public key.  The ID is also used a `kid` in the JWT header for payload encryption.  This allows the target to identify the correct key to use for decryption.",
    )
...
ActionServiceAddPublicKeyResponse.model_rebuild(raise_errors=False)
