...
class V2GetActiveIdentityProvidersResponse(BaseModel):
    ...
    identity_providers: Optional[List[V2IdentityProvider]] = Field(default=None, alias="identityProviders")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2GetActiveIdentityProvidersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2GetActiveIdentityProvidersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "identityProviders": [V2IdentityProvider.from_dict(_item) for _item in obj["identityProviders"]] if obj.get("identityProviders") is not None else None
        })
