...
class ProjectGrantResourceOwnerFilter(BaseModel):
    """
    ProjectGrantResourceOwnerFilter
    """ # noqa: E501
    project_grant_resource_owner_filter: BetaProjectServiceIDFilter = Field(alias="projectGrantResourceOwnerFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["projectGrantResourceOwnerFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectGrantResourceOwnerFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectGrantResourceOwnerFilter from a dict"""
        if obj is None:
            return None
