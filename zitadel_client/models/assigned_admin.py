...
class AssignedAdmin(BaseModel):
    """
    AssignedAdmin
    """ # noqa: E501
    assigned_admin: BetaOrganizationServiceAssignedAdmin = Field(alias="assignedAdmin")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["assignedAdmin"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignedAdmin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignedAdmin from a dict"""
        if obj is None:
            return None
