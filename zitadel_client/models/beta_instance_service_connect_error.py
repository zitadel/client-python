...
class BetaInstanceServiceConnectErrorCodeEnum(str, Enum):
    """BetaInstanceServiceConnectError - code"""
...
class BetaInstanceServiceConnectError(BaseModel):
    ...
    code: Optional[BetaInstanceServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaInstanceServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaInstanceServiceConnectError.model_rebuild(raise_errors=False)
