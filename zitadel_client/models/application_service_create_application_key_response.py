...
class ApplicationServiceCreateApplicationKeyResponse(BaseModel):
    """
    ApplicationServiceCreateApplicationKeyResponse
    """ # noqa: E501
    key_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the newly created application key.", alias="keyId")
    ...
    key_details: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="KeyDetails contains the serialized private key and additional information depending on the key type.  It must be stored safely, as it will not be possible to retrieve it again.  A new key can be generated using the CreateApplicationKey endpoint.", alias="keyDetails")
    __properties: ClassVar[List[str]] = ["keyId", "creationDate", "keyDetails"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationServiceCreateApplicationKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationServiceCreateApplicationKeyResponse from a dict"""
        if obj is None:
            return None
