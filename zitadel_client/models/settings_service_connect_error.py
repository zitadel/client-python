...
class SettingsServiceConnectErrorCodeEnum(str, Enum):
    """SettingsServiceConnectError - code"""
...
class SettingsServiceConnectError(BaseModel):
    ...
    code: Optional[SettingsServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[SettingsServiceAny]] = Field(
        default=None,
        alias="details",
...
SettingsServiceConnectError.model_rebuild(raise_errors=False)
