...
class ProjectServiceConnectErrorCodeEnum(str, Enum):
    """ProjectServiceConnectError - code"""
...
class ProjectServiceConnectError(BaseModel):
    ...
    code: Optional[ProjectServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[ProjectServiceAny]] = Field(
        default=None,
        alias="details",
...
ProjectServiceConnectError.model_rebuild(raise_errors=False)
