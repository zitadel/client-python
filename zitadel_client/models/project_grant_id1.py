...
class ProjectGrantId1(BaseModel):
    """
    ProjectGrantId1
    """ # noqa: E501
    project_grant_id: BetaAuthorizationServiceIDFilter = Field(alias="projectGrantId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectGrantId1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectGrantId1 from a dict"""
        if obj is None:
            return None
