...
class FeatureServiceConnectErrorCodeEnum(str, Enum):
    """FeatureServiceConnectError - code"""
...
class FeatureServiceConnectError(BaseModel):
    ...
    code: Optional[FeatureServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[FeatureServiceAny]] = Field(
        default=None,
        alias="details",
...
FeatureServiceConnectError.model_rebuild(raise_errors=False)
