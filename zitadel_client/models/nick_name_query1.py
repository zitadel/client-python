...
class NickNameQuery1(BaseModel):
    """
    NickNameQuery1
    """ # noqa: E501
    nick_name_query: BetaUserServiceNickNameQuery = Field(alias="nickNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["nickNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NickNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NickNameQuery1 from a dict"""
        if obj is None:
            return None
