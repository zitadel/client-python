...
class InstanceServiceConnectErrorCodeEnum(str, Enum):
    """InstanceServiceConnectError - code"""
...
class InstanceServiceConnectError(BaseModel):
    ...
    code: Optional[InstanceServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[InstanceServiceAny]] = Field(
        default=None,
        alias="details",
...
InstanceServiceConnectError.model_rebuild(raise_errors=False)
