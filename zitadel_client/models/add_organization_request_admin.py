...
class AddOrganizationRequestAdmin(BaseModel):
    ...
    human: Optional[V2AddHumanUserRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddOrganizationRequestAdmin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddOrganizationRequestAdmin from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "human": V2AddHumanUserRequest.from_dict(obj["human"]) if obj.get("human") is not None else None,
            "roles": obj.get("roles")
        })
