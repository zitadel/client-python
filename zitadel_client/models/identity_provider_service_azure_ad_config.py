...
class IdentityProviderServiceAzureADConfig(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdentityProviderServiceAzureADConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdentityProviderServiceAzureADConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tenant": IdentityProviderServiceAzureADTenant.from_dict(obj["tenant"]) if obj.get("tenant") is not None else None,
