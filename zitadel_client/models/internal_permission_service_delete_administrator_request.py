...
class InternalPermissionServiceDeleteAdministratorRequest(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(
        default=None,
        alias="userId",
        description="UserID is the ID of the user whose administrator roles should be removed.",
    )
...
InternalPermissionServiceDeleteAdministratorRequest.model_rebuild(raise_errors=False)
