...
class ApplicationServiceConnectErrorCodeEnum(str, Enum):
    """ApplicationServiceConnectError - code"""
...
class ApplicationServiceConnectError(BaseModel):
    ...
    code: Optional[ApplicationServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[ApplicationServiceAny]] = Field(
        default=None,
        alias="details",
