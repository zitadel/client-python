...
class ApplicationServiceCreateApplicationResponse(BaseModel):
    ...
    application_id: Optional[StrictStr] = Field(
        default=None,
        alias="applicationId",
        description="The unique ID of the newly created application.",
    )
    ...
    api_configuration: Optional[ApplicationServiceCreateAPIApplicationResponse] = Field(
        default=None, alias="apiConfiguration"
    )
    oidc_configuration: Optional[ApplicationServiceCreateOIDCApplicationResponse] = (
        Field(default=None, alias="oidcConfiguration")
    )
    saml_configuration: Optional[object] = Field(
...
ApplicationServiceCreateApplicationResponse.model_rebuild(raise_errors=False)
