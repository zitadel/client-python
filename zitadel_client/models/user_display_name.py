...
class UserDisplayName(BaseModel):
    ...
    UserDisplayName
    """ # noqa: E501
    user_display_name: BetaInternalPermissionServiceUserDisplayNameFilter = Field(alias="userDisplayName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDisplayName from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDisplayName from a dict"""
        if obj is None:
            return None
