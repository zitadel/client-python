...
class V2AzureADConfig(BaseModel):
    """
    V2AzureADConfig
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, alias="clientId")
    tenant: Optional[V2AzureADTenant] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2AzureADConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2AzureADConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tenant": V2AzureADTenant.from_dict(obj["tenant"]) if obj.get("tenant") is not None else None,
