...
class UserServiceIDPInformation(BaseModel):
    ...
    ldap: Optional[UserServiceIDPLDAPAccessInformation] = Field(
        default=None, alias="ldap"
    )
    oauth: Optional[UserServiceIDPOAuthAccessInformation] = Field(
        default=None, alias="oauth"
    )
    saml: Optional[UserServiceIDPSAMLAccessInformation] = Field(
...
UserServiceIDPInformation.model_rebuild(raise_errors=False)
