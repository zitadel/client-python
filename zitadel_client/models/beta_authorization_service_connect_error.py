...
class BetaAuthorizationServiceConnectErrorCodeEnum(str, Enum):
    """BetaAuthorizationServiceConnectError - code"""
...
class BetaAuthorizationServiceConnectError(BaseModel):
    ...
    code: Optional[BetaAuthorizationServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaAuthorizationServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaAuthorizationServiceConnectError.model_rebuild(raise_errors=False)
