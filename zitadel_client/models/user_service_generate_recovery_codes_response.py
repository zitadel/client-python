...
class UserServiceGenerateRecoveryCodesResponse(BaseModel):
    """
    UserServiceGenerateRecoveryCodesResponse
    """

    details: Optional[UserServiceDetails] = Field(default=None, alias="details")
    recovery_codes: Optional[List[StrictStr]] = Field(
        default=None, alias="recoveryCodes"
    )
...
UserServiceGenerateRecoveryCodesResponse.model_rebuild(raise_errors=False)
