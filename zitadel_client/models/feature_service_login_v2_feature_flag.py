...
class FeatureServiceLoginV2FeatureFlag(BaseModel):
    """
    FeatureServiceLoginV2FeatureFlag
    """

    required: Optional[StrictBool] = Field(default=None, alias="required")
...
FeatureServiceLoginV2FeatureFlag.model_rebuild(raise_errors=False)
