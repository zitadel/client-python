...
class OrganizationId2(BaseModel):
    ...
    OrganizationId2
    """ # noqa: E501
    organization_id: BetaAuthorizationServiceIDFilter = Field(alias="organizationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationId2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationId2 from a dict"""
        if obj is None:
            return None
