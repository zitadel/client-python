...
class BetaFeatureServiceGetInstanceFeaturesResponse(BaseModel):
    ...
    oidc_trigger_introspection_projections: Optional[BetaFeatureServiceFeatureFlag] = Field(default=None, alias="oidcTriggerIntrospectionProjections")
    oidc_legacy_introspection: Optional[BetaFeatureServiceFeatureFlag] = Field(default=None, alias="oidcLegacyIntrospection")
    ...
    web_key: Optional[BetaFeatureServiceFeatureFlag] = Field(default=None, alias="webKey")
    debug_oidc_parent_error: Optional[BetaFeatureServiceFeatureFlag] = Field(default=None, alias="debugOidcParentError")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaFeatureServiceGetInstanceFeaturesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaFeatureServiceGetInstanceFeaturesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "oidcTriggerIntrospectionProjections": BetaFeatureServiceFeatureFlag.from_dict(obj["oidcTriggerIntrospectionProjections"]) if obj.get("oidcTriggerIntrospectionProjections") is not None else None,
            "oidcLegacyIntrospection": BetaFeatureServiceFeatureFlag.from_dict(obj["oidcLegacyIntrospection"]) if obj.get("oidcLegacyIntrospection") is not None else None,
            ...
            "webKey": BetaFeatureServiceFeatureFlag.from_dict(obj["webKey"]) if obj.get("webKey") is not None else None,
            "debugOidcParentError": BetaFeatureServiceFeatureFlag.from_dict(obj["debugOidcParentError"]) if obj.get("debugOidcParentError") is not None else None,
