...
class AuthorizationIds(BaseModel):
    """
    AuthorizationIds
    """ # noqa: E501
    authorization_ids: BetaAuthorizationServiceInIDsFilter = Field(alias="authorizationIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["authorizationIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthorizationIds from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthorizationIds from a dict"""
        if obj is None:
            return None
