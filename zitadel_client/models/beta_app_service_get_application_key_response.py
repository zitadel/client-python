...
class BetaAppServiceGetApplicationKeyResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "expirationDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaAppServiceGetApplicationKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaAppServiceGetApplicationKeyResponse from a dict"""
        if obj is None:
            return None
