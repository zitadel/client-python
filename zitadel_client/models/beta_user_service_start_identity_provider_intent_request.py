...
class BetaUserServiceStartIdentityProviderIntentRequest(BaseModel):
    ...
    ldap: Optional[BetaUserServiceLDAPCredentials] = None
    urls: Optional[BetaUserServiceRedirectURLs] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceStartIdentityProviderIntentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceStartIdentityProviderIntentRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "idpId": obj.get("idpId"),
            "ldap": BetaUserServiceLDAPCredentials.from_dict(obj["ldap"]) if obj.get("ldap") is not None else None,
            "urls": BetaUserServiceRedirectURLs.from_dict(obj["urls"]) if obj.get("urls") is not None else None
        })
        return _obj
