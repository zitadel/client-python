...
class UserServiceUpdateUserResponse(BaseModel):
    """
    ...
    email_code: Optional[StrictStr] = Field(default=None, description="In case the email verification was set to return_code, the code will be returned", alias="emailCode")
    phone_code: Optional[StrictStr] = Field(default=None, description="In case the phone verification was set to return_code, the code will be returned", alias="phoneCode")
    __properties: ClassVar[List[str]] = ["changeDate", "emailCode", "phoneCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceUpdateUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceUpdateUserResponse from a dict"""
        if obj is None:
            return None
