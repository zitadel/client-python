...
class UserServiceUpdateUserResponse(BaseModel):
    ...
    email_code: Optional[StrictStr] = Field(
        default=None,
        alias="emailCode",
        description="In case the email verification was set to return_code, the code will be returned",
    )
    phone_code: Optional[StrictStr] = Field(
        default=None,
        alias="phoneCode",
        description="In case the phone verification was set to return_code, the code will be returned",
    )
...
UserServiceUpdateUserResponse.model_rebuild(raise_errors=False)
