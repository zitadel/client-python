...
class ProjectNameFilter(BaseModel):
    """
    ProjectNameFilter
    """ # noqa: E501
    project_name_filter: BetaProjectServiceProjectNameFilter = Field(alias="projectNameFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["projectNameFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectNameFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectNameFilter from a dict"""
        if obj is None:
            return None
