...
class UserServiceConnectErrorCodeEnum(str, Enum):
    """UserServiceConnectError - code"""
...
class UserServiceConnectError(BaseModel):
    ...
    code: Optional[UserServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[UserServiceAny]] = Field(
        default=None,
        alias="details",
...
UserServiceConnectError.model_rebuild(raise_errors=False)
