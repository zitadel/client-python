...
class IdentityProviderServiceJWTConfig(BaseModel):
    ...
    """ # noqa: E501
    jwt_endpoint: Optional[StrictStr] = Field(default=None, description="The endpoint where the JWT can be extracted.", alias="jwtEndpoint")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdentityProviderServiceJWTConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdentityProviderServiceJWTConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "jwtEndpoint": obj.get("jwtEndpoint"),
            "issuer": obj.get("issuer"),
            "keysEndpoint": obj.get("keysEndpoint"),
