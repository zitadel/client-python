...
class InUserEmailsQuery(BaseModel):
    """
    InUserEmailsQuery
    """ # noqa: E501
    in_user_emails_query: UserServiceInUserEmailsQuery = Field(alias="inUserEmailsQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InUserEmailsQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InUserEmailsQuery from a dict"""
        if obj is None:
            return None
