...
class ApplicationServiceApplication(BaseModel):
    ...
    state: Optional[ApplicationServiceApplicationState] = Field(
        default=None, alias="state"
    )
    name: Optional[StrictStr] = Field(
        default=None,
        alias="name",
        description="The name of the application. This can be displayed to users.",
    )
    project_id: Optional[StrictStr] = Field(
        default=None,
        alias="projectId",
        description="The ProjectID represents the ID of the project the application belongs to.",
    )
    api_configuration: Optional[ApplicationServiceAPIConfiguration] = Field(
        default=None, alias="apiConfiguration"
    )
    oidc_configuration: Optional[ApplicationServiceOIDCConfiguration] = Field(
        default=None, alias="oidcConfiguration"
    )
    saml_configuration: Optional[ApplicationServiceSAMLConfiguration] = Field(
