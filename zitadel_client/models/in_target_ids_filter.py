...
class InTargetIdsFilter(BaseModel):
    """
    InTargetIdsFilter
    """ # noqa: E501
    in_target_ids_filter: BetaActionServiceInTargetIDsFilter = Field(alias="inTargetIdsFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inTargetIdsFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InTargetIdsFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InTargetIdsFilter from a dict"""
        if obj is None:
            return None
