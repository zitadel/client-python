...
class V2RetrieveIdentityProviderIntentResponse(BaseModel):
    """
    V2RetrieveIdentityProviderIntentResponse
    """ # noqa: E501
    details: Optional[V2Details] = None
    idp_information: Optional[V2IDPInformation] = Field(default=None, alias="idpInformation")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2RetrieveIdentityProviderIntentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2RetrieveIdentityProviderIntentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "idpInformation": V2IDPInformation.from_dict(obj["idpInformation"]) if obj.get("idpInformation") is not None else None,
