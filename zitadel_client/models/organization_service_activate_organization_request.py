...
class OrganizationServiceActivateOrganizationRequest(BaseModel):
    ...
    organization_id: Optional[StrictStr] = Field(
        ...
        description="OrganizationID is the unique identifier of the organization to be activated.",
    )
...
OrganizationServiceActivateOrganizationRequest.model_rebuild(raise_errors=False)
