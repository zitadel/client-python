...
class AzureAd(BaseModel):
    ...
    AzureAd
    """ # noqa: E501
    azure_ad: IdentityProviderServiceAzureADConfig = Field(alias="azureAd")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureAd from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureAd from a dict"""
        if obj is None:
            return None
