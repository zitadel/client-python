...
class UserServiceAddHumanUserRequest(BaseModel):
    ...
    organization: Optional[UserServiceOrganization] = Field(
    ...
    metadata: Optional[List[UserServiceSetMetadataEntry]] = Field(
        default=None, alias="metadata"
    )
    idp_links: Optional[List[UserServiceIDPLink]] = Field(
    ...
    hashed_password: Optional[UserServiceHashedPassword] = Field(
        default=None, alias="hashedPassword"
    )
    password: Optional[UserServicePassword] = Field(default=None, alias="password")
...
UserServiceAddHumanUserRequest.model_rebuild(raise_errors=False)
