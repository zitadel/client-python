...
class BetaSessionServiceSession(BaseModel):
    """
    ...
    factors: Optional[BetaSessionServiceFactors] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaSessionServiceSession from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaSessionServiceSession from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "factors": BetaSessionServiceFactors.from_dict(obj["factors"]) if obj.get("factors") is not None else None,
