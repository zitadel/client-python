...
class V2SetSystemFeaturesRequest(BaseModel):
    """
    ...
    improved_performance: Optional[List[V2ImprovedPerformance]] = Field(default=None, description="Improves performance of specified execution paths.", alias="improvedPerformance")
    ...
    login_v2: Optional[V2LoginV2] = Field(default=None, alias="loginV2")
    ...
    __properties: ClassVar[List[str]] = ["loginDefaultOrg", "oidcTriggerIntrospectionProjections", "oidcLegacyIntrospection", "userSchema", "oidcTokenExchange", "actions", "improvedPerformance", "oidcSingleV1SessionTermination", "disableUserTokenEvent", "enableBackChannelLogout", "loginV2", "permissionCheckV2"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2SetSystemFeaturesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2SetSystemFeaturesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "loginV2": V2LoginV2.from_dict(obj["loginV2"]) if obj.get("loginV2") is not None else None,
