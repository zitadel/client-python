...
class NickNameQuery(BaseModel):
    ...
    NickNameQuery
    """ # noqa: E501
    nick_name_query: UserServiceNickNameQuery = Field(alias="nickNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NickNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NickNameQuery from a dict"""
        if obj is None:
            return None
