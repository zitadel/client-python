...
class OIDCServiceConnectErrorCodeEnum(str, Enum):
    """OIDCServiceConnectError - code"""
...
class OIDCServiceConnectError(BaseModel):
    ...
    code: Optional[OIDCServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[OIDCServiceAny]] = Field(
        default=None,
        alias="details",
