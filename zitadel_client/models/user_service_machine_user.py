...
class UserServiceMachineUser(BaseModel):
    """
    ...
    access_token_type: Optional[UserServiceAccessTokenType] = Field(
...
UserServiceMachineUser.model_rebuild(raise_errors=False)
