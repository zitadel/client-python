...
class BetaOIDCServiceConnectErrorCodeEnum(str, Enum):
    """BetaOIDCServiceConnectError - code"""
...
class BetaOIDCServiceConnectError(BaseModel):
    ...
    code: Optional[BetaOIDCServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaOIDCServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaOIDCServiceConnectError.model_rebuild(raise_errors=False)
