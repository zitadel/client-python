...
class SettingsServiceGetLegalAndSupportSettingsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SettingsServiceGetLegalAndSupportSettingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SettingsServiceGetLegalAndSupportSettingsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "settings": SettingsServiceLegalAndSupportSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
