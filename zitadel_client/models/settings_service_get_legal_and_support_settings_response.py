...
class SettingsServiceGetLegalAndSupportSettingsResponse(BaseModel):
    """
    ...
    settings: Optional[SettingsServiceLegalAndSupportSettings] = Field(
...
SettingsServiceGetLegalAndSupportSettingsResponse.model_rebuild(raise_errors=False)
