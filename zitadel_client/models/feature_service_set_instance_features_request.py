...
class FeatureServiceSetInstanceFeaturesRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["loginDefaultOrg", "oidcTriggerIntrospectionProjections", "oidcLegacyIntrospection", "userSchema", "oidcTokenExchange", "actions", "improvedPerformance", "webKey", "debugOidcParentError", "oidcSingleV1SessionTermination", "disableUserTokenEvent", "enableBackChannelLogout", "loginV2", "permissionCheckV2", "consoleUseV2UserApi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeatureServiceSetInstanceFeaturesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeatureServiceSetInstanceFeaturesRequest from a dict"""
        if obj is None:
            return None
