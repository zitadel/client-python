...
class SessionServiceSession(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, alias="id", description="Unique identifier of the session."
    )
    ...
    user_agent: Optional[SessionServiceUserAgent] = Field(
...
SessionServiceSession.model_rebuild(raise_errors=False)
