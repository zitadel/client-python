...
class BetaAuthorizationServiceCreateAuthorizationResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None,
        alias="id",
        description="ID is the unique identifier of the newly created authorization.",
    )
...
BetaAuthorizationServiceCreateAuthorizationResponse.model_rebuild(raise_errors=False)
