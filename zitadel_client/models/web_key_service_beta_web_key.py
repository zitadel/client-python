...
class WebKeyServiceBetaWebKey(BaseModel):
    """
    ...
    change_date: Optional[datetime] = Field(default=None, description="The timestamp of the last change to the key (e.g. creation, activation, deactivation).", alias="changeDate")
    state: Optional[WebKeyServiceBetaState] = WebKeyServiceBetaState.STATE_UNSPECIFIED
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebKeyServiceBetaWebKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebKeyServiceBetaWebKey from a dict"""
        if obj is None:
            return None
