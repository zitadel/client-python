...
class BetaFeatureServiceConnectErrorCodeEnum(str, Enum):
    """BetaFeatureServiceConnectError - code"""
...
class BetaFeatureServiceConnectError(BaseModel):
    ...
    code: Optional[BetaFeatureServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaFeatureServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaFeatureServiceConnectError.model_rebuild(raise_errors=False)
