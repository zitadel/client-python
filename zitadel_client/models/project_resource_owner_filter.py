...
class ProjectResourceOwnerFilter(BaseModel):
    """
    ProjectResourceOwnerFilter
    """ # noqa: E501
    project_resource_owner_filter: BetaProjectServiceIDFilter = Field(alias="projectResourceOwnerFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["projectResourceOwnerFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectResourceOwnerFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectResourceOwnerFilter from a dict"""
        if obj is None:
            return None
