...
class DomainQuery(BaseModel):
    ...
    DomainQuery
    """ # noqa: E501
    domain_query: OrganizationServiceOrganizationDomainQuery = Field(alias="domainQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainQuery from a dict"""
        if obj is None:
            return None
