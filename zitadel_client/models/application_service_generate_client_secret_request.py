...
class ApplicationServiceGenerateClientSecretRequest(BaseModel):
    ...
    application_id: Optional[StrictStr] = Field(
        default=None,
        alias="applicationId",
        description="The unique ID of the application to generate a new client secret for.",
    )
...
ApplicationServiceGenerateClientSecretRequest.model_rebuild(raise_errors=False)
