...
class EmailQuery1(BaseModel):
    """
    EmailQuery1
    """ # noqa: E501
    email_query: BetaUserServiceEmailQuery = Field(alias="emailQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["emailQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailQuery1 from a dict"""
        if obj is None:
            return None
