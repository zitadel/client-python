...
class BetaAuthorizationServiceDeleteAuthorizationRequest(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None,
        alias="id",
        description="ID is the unique identifier of the authorization that should be deleted.",
    )
...
BetaAuthorizationServiceDeleteAuthorizationRequest.model_rebuild(raise_errors=False)
