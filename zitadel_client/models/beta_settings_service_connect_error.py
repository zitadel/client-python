...
class BetaSettingsServiceConnectErrorCodeEnum(str, Enum):
    """BetaSettingsServiceConnectError - code"""
...
class BetaSettingsServiceConnectError(BaseModel):
    ...
    code: Optional[BetaSettingsServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaSettingsServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaSettingsServiceConnectError.model_rebuild(raise_errors=False)
