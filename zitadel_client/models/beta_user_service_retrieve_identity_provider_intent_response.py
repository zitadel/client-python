...
class BetaUserServiceRetrieveIdentityProviderIntentResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceRetrieveIdentityProviderIntentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceRetrieveIdentityProviderIntentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "idpInformation": BetaUserServiceIDPInformation.from_dict(obj["idpInformation"]) if obj.get("idpInformation") is not None else None,
