...
class V2AddHumanUserRequest1(BaseModel):
    ...
    organization: Optional[V2Organization] = None
    profile: V2SetHumanProfile1
    email: V2SetHumanEmail1
    phone: Optional[V2SetHumanPhone1] = None
    metadata: Optional[List[V2SetMetadataEntry1]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2AddHumanUserRequest1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2AddHumanUserRequest1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "organization": V2Organization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "profile": V2SetHumanProfile1.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
            "email": V2SetHumanEmail1.from_dict(obj["email"]) if obj.get("email") is not None else None,
            "phone": V2SetHumanPhone1.from_dict(obj["phone"]) if obj.get("phone") is not None else None,
            "metadata": [V2SetMetadataEntry1.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
