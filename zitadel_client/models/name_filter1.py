...
class NameFilter1(BaseModel):
    """
    NameFilter1
    """ # noqa: E501
    name_filter: BetaOrganizationServiceOrgNameFilter = Field(alias="nameFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["nameFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NameFilter1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NameFilter1 from a dict"""
        if obj is None:
            return None
