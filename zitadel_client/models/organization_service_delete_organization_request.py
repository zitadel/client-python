...
class OrganizationServiceDeleteOrganizationRequest(BaseModel):
    ...
    organization_id: Optional[StrictStr] = Field(
        ...
        description="OrganizationID is the unique identifier of the organization to be deleted.",
    )
...
OrganizationServiceDeleteOrganizationRequest.model_rebuild(raise_errors=False)
