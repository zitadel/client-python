...
class ActionServiceListTargetsResponse(BaseModel):
    ...
    targets: Optional[List[ActionServiceTarget]] = Field(
        default=None,
        alias="targets",
        description="List of all targets matching the query.",
    )
...
ActionServiceListTargetsResponse.model_rebuild(raise_errors=False)
