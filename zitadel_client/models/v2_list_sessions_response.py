...
class V2ListSessionsResponse(BaseModel):
    ...
    """ # noqa: E501
    details: Optional[Objectv2ListDetails] = None
    sessions: Optional[List[V2Session1]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2ListSessionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2ListSessionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "details": Objectv2ListDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
            "sessions": [V2Session1.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
