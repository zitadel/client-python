...
class OrganizationServiceListDetails(BaseModel):
    """
    OrganizationServiceListDetails
    """ # noqa: E501
    total_result: Optional[Any] = Field(default=None, alias="totalResult")
    processed_sequence: Optional[Any] = Field(default=None, alias="processedSequence")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationServiceListDetails from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if processed_sequence (nullable) is None
        # and model_fields_set contains the field
        if self.processed_sequence is None and "processed_sequence" in self.model_fields_set:
            _dict['processedSequence'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationServiceListDetails from a dict"""
        if obj is None:
            return None
