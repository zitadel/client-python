...
class OrganizationServiceListDetails(BaseModel):
    ...
    total_result: Optional[object] = Field(default=None, alias="totalResult")
    processed_sequence: Optional[object] = Field(
        default=None, alias="processedSequence"
    )
...
OrganizationServiceListDetails.model_rebuild(raise_errors=False)
