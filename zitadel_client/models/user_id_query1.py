...
class UserIdQuery1(BaseModel):
    """
    UserIdQuery1
    """ # noqa: E501
    user_id_query: SessionServiceUserIDQuery = Field(alias="userIdQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userIdQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserIdQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserIdQuery1 from a dict"""
        if obj is None:
            return None
