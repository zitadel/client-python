...
class InUserIdsFilter(BaseModel):
    """
    InUserIdsFilter
    """ # noqa: E501
    in_user_ids_filter: BetaInternalPermissionServiceInIDsFilter = Field(alias="inUserIdsFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inUserIdsFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InUserIdsFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InUserIdsFilter from a dict"""
        if obj is None:
            return None
