...
class BetaOrganizationServiceConnectErrorCodeEnum(str, Enum):
    """BetaOrganizationServiceConnectError - code"""
...
class BetaOrganizationServiceConnectError(BaseModel):
    ...
    code: Optional[BetaOrganizationServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaOrganizationServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaOrganizationServiceConnectError.model_rebuild(raise_errors=False)
