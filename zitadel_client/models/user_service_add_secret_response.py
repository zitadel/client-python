...
class UserServiceAddSecretResponse(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(
        default=None,
        alias="clientSecret",
        description="The client secret.  Store this secret in a secure place.  It is not possible to retrieve it again.",
    )
...
UserServiceAddSecretResponse.model_rebuild(raise_errors=False)
