...
class UserServiceAddSecretResponse(BaseModel):
    """
    ...
    client_secret: Optional[StrictStr] = Field(default=None, description="The client secret.  Store this secret in a secure place.  It is not possible to retrieve it again.", alias="clientSecret")
    __properties: ClassVar[List[str]] = ["creationDate", "clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceAddSecretResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceAddSecretResponse from a dict"""
        if obj is None:
            return None
