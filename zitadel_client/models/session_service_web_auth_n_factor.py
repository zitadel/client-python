...
class SessionServiceWebAuthNFactor(BaseModel):
    ...
    verified_at: Optional[AwareDatetime] = Field(
        default=None,
        alias="verifiedAt",
    ...
    user_verified: Optional[StrictBool] = Field(
        default=None,
        alias="userVerified",
        description="Indicates if the user presence was verified during the last challenge.  This can be used to determine if the factor can be considered as multi-factor authentication.",
    )
...
SessionServiceWebAuthNFactor.model_rebuild(raise_errors=False)
