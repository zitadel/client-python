...
class NotQuery(BaseModel):
    ...
    NotQuery
    """ # noqa: E501
    not_query: UserServiceNotQuery = Field(alias="notQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotQuery from a dict"""
        if obj is None:
            return None
...
NotQuery.model_rebuild(raise_errors=False)
