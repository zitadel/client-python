...
class ActionServiceTarget(BaseModel):
    """
    ActionServiceTarget
    """ # noqa: E501
    ...
    name: Optional[StrictStr] = Field(default=None, description="Display name of the target.")
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "changeDate", "name", "timeout", "endpoint", "signingKey", "payloadType", "restAsync", "restCall", "restWebhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionServiceTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionServiceTarget from a dict"""
        if obj is None:
            return None
