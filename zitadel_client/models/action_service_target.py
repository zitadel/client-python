...
class ActionServiceTarget(BaseModel):
    ...
    name: Optional[StrictStr] = Field(
        default=None, alias="name", description="Display name of the target."
    )
...
ActionServiceTarget.model_rebuild(raise_errors=False)
