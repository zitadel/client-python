...
class BetaUserServiceConnectErrorCodeEnum(str, Enum):
    """BetaUserServiceConnectError - code"""
...
class BetaUserServiceConnectError(BaseModel):
    ...
    code: Optional[BetaUserServiceConnectErrorCodeEnum] = Field(
        default=None,
        alias="code",
    ...
    details: Optional[List[BetaUserServiceAny]] = Field(
        default=None,
        alias="details",
...
BetaUserServiceConnectError.model_rebuild(raise_errors=False)
