...
class BetaProjectServiceProject(BaseModel):
    ...
    state: Optional[BetaProjectServiceProjectState] = None
    project_role_assertion: Optional[StrictBool] = Field(default=None, description="Describes if the roles of the user should be added to the token.", alias="projectRoleAssertion")
    ...
    granted_organization_id: Optional[StrictStr] = Field(default=None, description="The ID of the organization the project is granted to.", alias="grantedOrganizationId")
    granted_organization_name: Optional[StrictStr] = Field(default=None, description="The name of the organization the project is granted to.", alias="grantedOrganizationName")
    granted_state: Optional[BetaProjectServiceGrantedProjectState] = Field(default=None, alias="grantedState")
    __properties: ClassVar[List[str]] = ["id", "organizationId", "creationDate", "changeDate", "name", "state", "projectRoleAssertion", "authorizationRequired", "projectAccessRequired", "privateLabelingSetting", "grantedOrganizationId", "grantedOrganizationName", "grantedState"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaProjectServiceProject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaProjectServiceProject from a dict"""
        if obj is None:
            return None
