...
class LastNameQuery(BaseModel):
    """
    LastNameQuery
    """ # noqa: E501
    last_name_query: UserServiceLastNameQuery = Field(alias="lastNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LastNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LastNameQuery from a dict"""
        if obj is None:
            return None
