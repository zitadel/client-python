...
class BetaSessionServiceCheckWebAuthN(BaseModel):
    """
    BetaSessionServiceCheckWebAuthN
    """ # noqa: E501
    credential_assertion_data: Dict[str, BetaSessionServiceValue] = Field(description="`Struct` represents a structured data value, consisting of fields  which map to dynamically typed values. In some languages, `Struct`  might be supported by a native representation. For example, in  scripting languages like JS a struct is represented as an  object. The details of that representation are described together  with the proto support for the language.   The JSON representation for `Struct` is JSON object.", alias="credentialAssertionData")
    __properties: ClassVar[List[str]] = ["credentialAssertionData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaSessionServiceCheckWebAuthN from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaSessionServiceCheckWebAuthN from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "credentialAssertionData": dict(
                (_k, BetaSessionServiceValue.from_dict(_v))
