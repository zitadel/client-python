...
class BetaOIDCServiceAuthRequest(BaseModel):
    ...
    scope: Optional[List[StrictStr]] = Field(default=None, alias="scope")
    redirect_uri: Optional[StrictStr] = Field(default=None, alias="redirectUri")
    prompt: Optional[List[BetaOIDCServicePrompt]] = Field(default=None, alias="prompt")
...
BetaOIDCServiceAuthRequest.model_rebuild(raise_errors=False)
