...
class OrganizationServiceDeactivateOrganizationRequest(BaseModel):
    ...
    organization_id: Optional[StrictStr] = Field(
        ...
        description="OrganizationID is the unique identifier of the organization to be deactivated.",
    )
...
OrganizationServiceDeactivateOrganizationRequest.model_rebuild(raise_errors=False)
