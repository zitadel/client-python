...
class StateQuery(BaseModel):
    ...
    StateQuery
    """ # noqa: E501
    state_query: UserServiceStateQuery = Field(alias="stateQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateQuery from a dict"""
        if obj is None:
            return None
