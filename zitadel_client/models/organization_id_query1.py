...
class OrganizationIdQuery1(BaseModel):
    """
    OrganizationIdQuery1
    """ # noqa: E501
    organization_id_query: BetaUserServiceOrganizationIdQuery = Field(alias="organizationIdQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["organizationIdQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationIdQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationIdQuery1 from a dict"""
        if obj is None:
            return None
