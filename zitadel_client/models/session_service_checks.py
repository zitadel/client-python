...
class SessionServiceChecks(BaseModel):
    ...
    """ # noqa: E501
    user: Optional[SessionServiceCheckUser] = None
    password: Optional[SessionServiceCheckPassword] = None
    web_auth_n: Optional[SessionServiceCheckWebAuthN] = Field(default=None, alias="webAuthN")
    idp_intent: Optional[SessionServiceCheckIDPIntent] = Field(default=None, alias="idpIntent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionServiceChecks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionServiceChecks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user": SessionServiceCheckUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "password": SessionServiceCheckPassword.from_dict(obj["password"]) if obj.get("password") is not None else None,
            "webAuthN": SessionServiceCheckWebAuthN.from_dict(obj["webAuthN"]) if obj.get("webAuthN") is not None else None,
