...
class BetaAppServiceApplication(BaseModel):
    """
    ...
    state: Optional[BetaAppServiceAppState] = None
    name: Optional[StrictStr] = None
    api_config: Optional[BetaAppServiceAPIConfig] = Field(default=None, alias="apiConfig")
    oidc_config: Optional[BetaAppServiceOIDCConfig] = Field(default=None, alias="oidcConfig")
    saml_config: Optional[BetaAppServiceSAMLConfig] = Field(default=None, alias="samlConfig")
    __properties: ClassVar[List[str]] = ["id", "creationDate", "changeDate", "state", "name", "apiConfig", "oidcConfig", "samlConfig"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaAppServiceApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaAppServiceApplication from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "name": obj.get("name"),
            "apiConfig": BetaAppServiceAPIConfig.from_dict(obj["apiConfig"]) if obj.get("apiConfig") is not None else None,
            "oidcConfig": BetaAppServiceOIDCConfig.from_dict(obj["oidcConfig"]) if obj.get("oidcConfig") is not None else None,
            "samlConfig": BetaAppServiceSAMLConfig.from_dict(obj["samlConfig"]) if obj.get("samlConfig") is not None else None
        })
        return _obj
