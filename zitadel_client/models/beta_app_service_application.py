...
class BetaAppServiceApplication(BaseModel):
    ...
    state: Optional[BetaAppServiceAppState] = Field(default=None, alias="state")
    name: Optional[StrictStr] = Field(default=None, alias="name")
    api_config: Optional[BetaAppServiceAPIConfig] = Field(
        default=None, alias="apiConfig"
    )
    oidc_config: Optional[BetaAppServiceOIDCConfig] = Field(
        default=None, alias="oidcConfig"
    )
    saml_config: Optional[BetaAppServiceSAMLConfig] = Field(
        default=None, alias="samlConfig"
    )
...
BetaAppServiceApplication.model_rebuild(raise_errors=False)
