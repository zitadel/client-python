...
class FirstNameQuery1(BaseModel):
    """
    FirstNameQuery1
    """ # noqa: E501
    first_name_query: BetaUserServiceFirstNameQuery = Field(alias="firstNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["firstNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FirstNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FirstNameQuery1 from a dict"""
        if obj is None:
            return None
