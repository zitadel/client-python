...
class InUserIdsQuery1(BaseModel):
    """
    InUserIdsQuery1
    """ # noqa: E501
    in_user_ids_query: BetaUserServiceInUserIDQuery = Field(alias="inUserIdsQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inUserIdsQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InUserIdsQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InUserIdsQuery1 from a dict"""
        if obj is None:
            return None
