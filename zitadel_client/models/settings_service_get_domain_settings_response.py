...
class SettingsServiceGetDomainSettingsResponse(BaseModel):
    """
    SettingsServiceGetDomainSettingsResponse
    """ # noqa: E501
    details: Optional[SettingsServiceDetails] = None
    settings: Optional[SettingsServiceDomainSettings] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SettingsServiceGetDomainSettingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SettingsServiceGetDomainSettingsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "settings": SettingsServiceDomainSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
