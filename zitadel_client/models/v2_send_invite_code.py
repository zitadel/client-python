...
class V2SendInviteCode(BaseModel):
    """
    V2SendInviteCode
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["urlTemplate", "applicationName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2SendInviteCode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2SendInviteCode from a dict"""
        if obj is None:
            return None
