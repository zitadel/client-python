...
class CreationDateQuery1(BaseModel):
    """
    CreationDateQuery1
    """ # noqa: E501
    creation_date_query: SessionServiceCreationDateQuery = Field(alias="creationDateQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreationDateQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreationDateQuery1 from a dict"""
        if obj is None:
            return None
