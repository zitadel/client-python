...
class TokenIdFilter(BaseModel):
    """
    TokenIdFilter
    """ # noqa: E501
    token_id_filter: UserServiceIDFilter = Field(alias="tokenIdFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tokenIdFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TokenIdFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TokenIdFilter from a dict"""
        if obj is None:
            return None
