...
class ProjectServiceProjectRole(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(
        default=None,
        alias="projectId",
        description="ProjectID is the ID of the project the role belongs to.",
    )
    key: Optional[StrictStr] = Field(
        default=None,
        alias="key",
        description="Key of the project role. The key identifies the role. It's the only relevant attribute for ZITADEL and  will be used for authorization checks and as claim in tokens and user info responses.",
    )
...
ProjectServiceProjectRole.model_rebuild(raise_errors=False)
