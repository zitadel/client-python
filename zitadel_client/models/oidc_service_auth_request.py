...
class OIDCServiceAuthRequest(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the authorization request.")
    ...
    client_id: Optional[StrictStr] = Field(default=None, description="The OAuth2/OIDC client_id of the application that initiated the authorization request.", alias="clientId")
    scope: Optional[List[StrictStr]] = Field(default=None, description="The scopes by the application that the user must consent to.")
    redirect_uri: Optional[StrictStr] = Field(default=None, description="The redirect_uri used in the authorization request. This must exactly match one of the redirect URIs registered for the client.  This uri is used to send the authorization code or tokens back to the application.", alias="redirectUri")
