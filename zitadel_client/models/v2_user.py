...
class V2User(BaseModel):
    ...
    human: Optional[V2HumanUser] = None
    machine: Optional[V2MachineUser] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2User from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2User from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "human": V2HumanUser.from_dict(obj["human"]) if obj.get("human") is not None else None,
            "machine": V2MachineUser.from_dict(obj["machine"]) if obj.get("machine") is not None else None
        })
