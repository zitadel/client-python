...
class OrganizationServiceDeleteOrganizationDomainRequest(BaseModel):
    ...
    """ # noqa: E501
    organization_id: Optional[StrictStr] = Field(default=None, description="OrganizationID is the unique identifier of the organization from which the domain is to be deleted.", alias="organizationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationServiceDeleteOrganizationDomainRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationServiceDeleteOrganizationDomainRequest from a dict"""
        if obj is None:
            return None
