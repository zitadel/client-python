...
class InstanceServiceInstance(BaseModel):
    """
    InstanceServiceInstance
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID is the unique identifier of the instance.")
    ...
    state: Optional[InstanceServiceState] = None
    name: Optional[StrictStr] = Field(default=None, description="Name is the display name of the instance.  This can be changed by the instance administrator.")
    ...
    custom_domains: Optional[List[InstanceServiceCustomDomain]] = Field(default=None, description="CustomDomains are the domains that are assigned to the instance.  The list includes auto-generated and manually added domains.  They are all unique across all instances in the system.  They're used to route requests to the correct instance.", alias="customDomains")
    __properties: ClassVar[List[str]] = ["id", "changeDate", "creationDate", "state", "name", "version", "customDomains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceServiceInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceServiceInstance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "customDomains": [InstanceServiceCustomDomain.from_dict(_item) for _item in obj["customDomains"]] if obj.get("customDomains") is not None else None
        })
        return _obj
