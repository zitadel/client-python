...
class UserServiceStartIdentityProviderIntentRequest(BaseModel):
    ...
    ldap: Optional[UserServiceLDAPCredentials] = Field(default=None, alias="ldap")
    urls: Optional[UserServiceRedirectURLs] = Field(default=None, alias="urls")
...
UserServiceStartIdentityProviderIntentRequest.model_rebuild(raise_errors=False)
