...
class UserDisplayName1(BaseModel):
    """
    UserDisplayName1
    """ # noqa: E501
    user_display_name: BetaAuthorizationServiceUserDisplayNameQuery = Field(alias="userDisplayName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userDisplayName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDisplayName1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDisplayName1 from a dict"""
        if obj is None:
            return None
