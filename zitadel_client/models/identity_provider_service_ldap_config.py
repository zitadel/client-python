...
class IdentityProviderServiceLDAPConfig(BaseModel):
    ...
    servers: Optional[List[StrictStr]] = Field(default=None, alias="servers")
    ...
    user_object_classes: Optional[List[StrictStr]] = Field(
        default=None, alias="userObjectClasses"
    )
...
IdentityProviderServiceLDAPConfig.model_rebuild(raise_errors=False)
