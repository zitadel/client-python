...
class BetaOrganizationServiceDeleteOrganizationDomainRequest(BaseModel):
    ...
    organization_id: Optional[StrictStr] = Field(
        ...
        description="Organization Id for the Organization which domain is to be deleted.",
    )
...
BetaOrganizationServiceDeleteOrganizationDomainRequest.model_rebuild(raise_errors=False)
