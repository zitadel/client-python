...
class ActionServiceListTargetsRequest(BaseModel):
    ...
    sorting_column: Optional[ActionServiceTargetFieldName] = Field(default=None, alias="sortingColumn")
    filters: Optional[List[ActionServiceTargetSearchFilter]] = Field(default=None, description="Define the criteria to query for.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": [ActionServiceTargetSearchFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
