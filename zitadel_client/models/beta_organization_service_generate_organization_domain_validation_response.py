...
class BetaOrganizationServiceGenerateOrganizationDomainValidationResponse(BaseModel):
    ...
    token: Optional[StrictStr] = Field(
        default=None, alias="token", description="The token verify domain."
    )
    url: Optional[StrictStr] = Field(
        default=None, alias="url", description="URL used to verify the domain."
    )
...
BetaOrganizationServiceGenerateOrganizationDomainValidationResponse.model_rebuild(
    raise_errors=False
)
