...
class UserServiceUser(BaseModel):
    ...
    human: Optional[UserServiceHumanUser] = Field(default=None, alias="human")
    machine: Optional[UserServiceMachineUser] = Field(default=None, alias="machine")
...
UserServiceUser.model_rebuild(raise_errors=False)
