...
class DisplayNameQuery1(BaseModel):
    """
    DisplayNameQuery1
    """ # noqa: E501
    display_name_query: BetaUserServiceDisplayNameQuery = Field(alias="displayNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["displayNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DisplayNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DisplayNameQuery1 from a dict"""
        if obj is None:
            return None
