...
class LoginNameQuery(BaseModel):
    """
    LoginNameQuery
    """ # noqa: E501
    login_name_query: UserServiceLoginNameQuery = Field(alias="loginNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoginNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoginNameQuery from a dict"""
        if obj is None:
            return None
