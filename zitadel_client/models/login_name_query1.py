...
class LoginNameQuery1(BaseModel):
    """
    LoginNameQuery1
    """ # noqa: E501
    login_name_query: BetaUserServiceLoginNameQuery = Field(alias="loginNameQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["loginNameQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoginNameQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoginNameQuery1 from a dict"""
        if obj is None:
            return None
