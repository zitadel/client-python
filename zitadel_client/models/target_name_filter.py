...
class TargetNameFilter(BaseModel):
    """
    TargetNameFilter
    """ # noqa: E501
    target_name_filter: BetaActionServiceTargetNameFilter = Field(alias="targetNameFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["targetNameFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TargetNameFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TargetNameFilter from a dict"""
        if obj is None:
            return None
