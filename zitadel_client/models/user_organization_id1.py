...
class UserOrganizationId1(BaseModel):
    """
    UserOrganizationId1
    """ # noqa: E501
    user_organization_id: BetaAuthorizationServiceIDFilter = Field(alias="userOrganizationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userOrganizationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserOrganizationId1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserOrganizationId1 from a dict"""
        if obj is None:
            return None
