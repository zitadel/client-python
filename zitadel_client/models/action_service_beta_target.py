...
class ActionServiceBetaTarget(BaseModel):
    """
    ...
    change_date: Optional[datetime] = Field(default=None, description="The timestamp of the last change to the target (e.g. creation, activation, deactivation).", alias="changeDate")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionServiceBetaTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionServiceBetaTarget from a dict"""
        if obj is None:
            return None
