...
class BetaUserServiceStartIdentityProviderIntentResponse(BaseModel):
    ...
    auth_url: Optional[StrictStr] = Field(
        default=None,
        alias="authUrl",
    ...
    idp_intent: Optional[BetaUserServiceIDPIntent] = Field(
...
BetaUserServiceStartIdentityProviderIntentResponse.model_rebuild(raise_errors=False)
