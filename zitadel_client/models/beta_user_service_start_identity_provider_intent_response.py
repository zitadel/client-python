...
class BetaUserServiceStartIdentityProviderIntentResponse(BaseModel):
    ...
    form_data: Optional[BetaUserServiceFormData] = Field(default=None, alias="formData")
    idp_intent: Optional[BetaUserServiceIDPIntent] = Field(default=None, alias="idpIntent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceStartIdentityProviderIntentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceStartIdentityProviderIntentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "formData": BetaUserServiceFormData.from_dict(obj["formData"]) if obj.get("formData") is not None else None,
            "idpIntent": BetaUserServiceIDPIntent.from_dict(obj["idpIntent"]) if obj.get("idpIntent") is not None else None,
