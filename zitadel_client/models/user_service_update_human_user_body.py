...
class UserServiceUpdateHumanUserBody(BaseModel):
    ...
    profile: Optional[V2SetHumanProfile1] = None
    email: Optional[V2SetHumanEmail1] = None
    phone: Optional[V2SetHumanPhone1] = None
    password: Optional[Userv2SetPassword] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["username", "profile", "email", "phone", "password"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceUpdateHumanUserBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceUpdateHumanUserBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "password": Userv2SetPassword.from_dict(obj["password"]) if obj.get("password") is not None else None
        })
