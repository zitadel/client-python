...
class HashedPassword1(BaseModel):
    """
    HashedPassword1
    """ # noqa: E501
    hashed_password: OrganizationServiceHashedPassword = Field(alias="hashedPassword")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HashedPassword1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HashedPassword1 from a dict"""
        if obj is None:
            return None
