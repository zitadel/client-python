...
class NotQuery1(BaseModel):
    """
    NotQuery1
    """ # noqa: E501
    not_query: BetaUserServiceNotQuery = Field(alias="notQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["notQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotQuery1 from a dict"""
        if obj is None:
            return None
...
NotQuery1.model_rebuild(raise_errors=False)
