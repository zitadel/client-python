...
class CreatedAdmin(BaseModel):
    ...
    CreatedAdmin
    """ # noqa: E501
    created_admin: BetaOrganizationServiceCreatedAdmin = Field(alias="createdAdmin")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdAdmin"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatedAdmin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatedAdmin from a dict"""
        if obj is None:
            return None
