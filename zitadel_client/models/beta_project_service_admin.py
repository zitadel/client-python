...
class BetaProjectServiceAdmin(BaseModel):
    ...
    roles: Optional[List[StrictStr]] = Field(
        default=None,
        alias="roles",
        description="specify the Project Member Roles for the provided user (default is PROJECT_OWNER if roles are empty",
    )
...
BetaProjectServiceAdmin.model_rebuild(raise_errors=False)
