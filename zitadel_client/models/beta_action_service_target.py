...
class BetaActionServiceTarget(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the target.")
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "changeDate", "name", "timeout", "endpoint", "signingKey", "restAsync", "restCall", "restWebhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaActionServiceTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaActionServiceTarget from a dict"""
        if obj is None:
            return None
