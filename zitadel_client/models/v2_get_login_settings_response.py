...
class V2GetLoginSettingsResponse(BaseModel):
    """
    V2GetLoginSettingsResponse
    """ # noqa: E501
    details: Optional[V2Details] = None
    settings: Optional[V2LoginSettings] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2GetLoginSettingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2GetLoginSettingsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "settings": V2LoginSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
