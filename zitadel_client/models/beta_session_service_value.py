...
BETASESSIONSERVICEVALUE_ONE_OF_SCHEMAS = ["Dict[str, object]", "List[str]", "bool", "float", "str"]
...
class BetaSessionServiceValue(BaseModel):
    ...
    actual_instance: Optional[Union[Dict[str, object], List[str], bool, float, str]] = None
    one_of_schemas: Set[str] = { "Dict[str, object]", "List[str]", "bool", "float", "str" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BetaSessionServiceValue with oneOf schemas: Dict[str, object], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BetaSessionServiceValue with oneOf schemas: Dict[str, object], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into BetaSessionServiceValue with oneOf schemas: Dict[str, object], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into BetaSessionServiceValue with oneOf schemas: Dict[str, object], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Dict[str, object], List[str], bool, float, str]]:
