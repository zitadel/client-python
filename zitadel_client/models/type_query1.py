...
class TypeQuery1(BaseModel):
    """
    TypeQuery1
    """ # noqa: E501
    type_query: BetaUserServiceTypeQuery = Field(alias="typeQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["typeQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypeQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypeQuery1 from a dict"""
        if obj is None:
            return None
