...
class DomainFilter(BaseModel):
    ...
    DomainFilter
    """ # noqa: E501
    domain_filter: BetaOrganizationServiceOrgDomainFilter = Field(alias="domainFilter")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainFilter from a dict"""
        if obj is None:
            return None
