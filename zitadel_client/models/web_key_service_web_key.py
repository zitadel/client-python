...
class WebKeyServiceWebKey(BaseModel):
    """
    WebKeyServiceWebKey
    """
    ...
    state: Optional[WebKeyServiceState] = Field(default=None, alias="state")
    ecdsa: Optional[WebKeyServiceECDSA] = Field(default=None, alias="ecdsa")
    ed25519: Optional[object] = Field(default=None, alias="ed25519")
    rsa: Optional[WebKeyServiceRSA] = Field(default=None, alias="rsa")
...
WebKeyServiceWebKey.model_rebuild(raise_errors=False)
