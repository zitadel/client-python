...
class GithubEs(BaseModel):
    """
    GithubEs
    """ # noqa: E501
    github_es: IdentityProviderServiceGitHubEnterpriseServerConfig = Field(alias="githubEs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GithubEs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GithubEs from a dict"""
        if obj is None:
            return None
