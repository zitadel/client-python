...
class UserServiceAddPersonalAccessTokenResponse(BaseModel):
    ...
    token_id: Optional[StrictStr] = Field(
        default=None, alias="tokenId", description="The tokens ID."
    )
    token: Optional[StrictStr] = Field(
        default=None,
        alias="token",
        description="The personal access token that can be used to authenticate against the API",
    )
...
UserServiceAddPersonalAccessTokenResponse.model_rebuild(raise_errors=False)
