...
class UserServiceAddPersonalAccessTokenResponse(BaseModel):
    """
    ...
    token_id: Optional[StrictStr] = Field(default=None, description="The tokens ID.", alias="tokenId")
    token: Optional[StrictStr] = Field(default=None, description="The personal access token that can be used to authenticate against the API")
    __properties: ClassVar[List[str]] = ["creationDate", "tokenId", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserServiceAddPersonalAccessTokenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserServiceAddPersonalAccessTokenResponse from a dict"""
        if obj is None:
            return None
