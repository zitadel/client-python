...
class ProjectOrganizationIdFilter(BaseModel):
    """
    ProjectOrganizationIdFilter
    """ # noqa: E501
    project_organization_id_filter: BetaProjectServiceIDFilter = Field(alias="projectOrganizationIdFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["projectOrganizationIdFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectOrganizationIdFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectOrganizationIdFilter from a dict"""
        if obj is None:
            return None
