...
class BetaActionServiceExecution(BaseModel):
    """
    BetaActionServiceExecution
    """

    condition: Optional[BetaActionServiceCondition] = Field(
    ...
    targets: Optional[List[StrictStr]] = Field(
        default=None,
        alias="targets",
        description="Ordered list of targets called during the execution.",
    )
...
BetaActionServiceExecution.model_rebuild(raise_errors=False)
