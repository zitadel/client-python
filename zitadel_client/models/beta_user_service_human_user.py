...
class BetaUserServiceHumanUser(BaseModel):
    ...
    profile: Optional[BetaUserServiceHumanProfile] = Field(
        default=None, alias="profile"
    )
    email: Optional[BetaUserServiceHumanEmail] = Field(default=None, alias="email")
    phone: Optional[BetaUserServiceHumanPhone] = Field(default=None, alias="phone")
