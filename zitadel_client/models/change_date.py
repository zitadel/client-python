...
class ChangeDate(BaseModel):
    ...
    ChangeDate
    """ # noqa: E501
    change_date: BetaInternalPermissionServiceTimestampFilter = Field(alias="changeDate")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChangeDate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChangeDate from a dict"""
        if obj is None:
            return None
