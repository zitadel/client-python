...
class InstanceServiceRemoveCustomDomainRequest(BaseModel):
    ...
    instance_id: Optional[StrictStr] = Field(
        default=None,
        alias="instanceId",
        description="InstanceID is the unique ID of the instance from which the domain will be removed.",
    )
    custom_domain: Optional[StrictStr] = Field(
        default=None,
        alias="customDomain",
        description="CustomDomain is the the domain to remove from the instance.",
    )
...
InstanceServiceRemoveCustomDomainRequest.model_rebuild(raise_errors=False)
