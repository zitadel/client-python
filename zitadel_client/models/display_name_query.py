...
class DisplayNameQuery(BaseModel):
    ...
    DisplayNameQuery
    """ # noqa: E501
    display_name_query: UserServiceDisplayNameQuery = Field(alias="displayNameQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DisplayNameQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DisplayNameQuery from a dict"""
        if obj is None:
            return None
