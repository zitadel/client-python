...
class OrganizationIdFilter(BaseModel):
    """
    OrganizationIdFilter
    """ # noqa: E501
    organization_id_filter: UserServiceIDFilter = Field(alias="organizationIdFilter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["organizationIdFilter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationIdFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationIdFilter from a dict"""
        if obj is None:
            return None
