...
class BetaUserServiceRegisterPasskeyResponse(BaseModel):
    ...
    public_key_credential_creation_options: Optional[Dict[str, object]] = Field(
        default=None,
        alias="publicKeyCredentialCreationOptions",
...
BetaUserServiceRegisterPasskeyResponse.model_rebuild(raise_errors=False)
