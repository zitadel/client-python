...
class StateQuery1(BaseModel):
    """
    StateQuery1
    """ # noqa: E501
    state_query: OrganizationServiceOrganizationStateQuery = Field(alias="stateQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["stateQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateQuery1 from a dict"""
        if obj is None:
            return None
