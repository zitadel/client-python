...
class BetaInternalPermissionServiceDeleteAdministratorRequest(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(
        default=None,
        alias="userId",
        description="UserID is the ID of the user who should have his administrator roles removed.",
    )
...
BetaInternalPermissionServiceDeleteAdministratorRequest.model_rebuild(
    raise_errors=False
)
