...
class StateQuery2(BaseModel):
    """
    StateQuery2
    """ # noqa: E501
    state_query: BetaUserServiceStateQuery = Field(alias="stateQuery")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateQuery2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateQuery2 from a dict"""
        if obj is None:
            return None
