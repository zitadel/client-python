...
class BetaUserServiceSetPasswordRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaUserServiceSetPasswordRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaUserServiceSetPasswordRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "newPassword": BetaUserServicePassword.from_dict(obj["newPassword"]) if obj.get("newPassword") is not None else None,
