...
class InUserEmailsQuery1(BaseModel):
    """
    InUserEmailsQuery1
    """ # noqa: E501
    in_user_emails_query: BetaUserServiceInUserEmailsQuery = Field(alias="inUserEmailsQuery")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inUserEmailsQuery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InUserEmailsQuery1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InUserEmailsQuery1 from a dict"""
        if obj is None:
            return None
