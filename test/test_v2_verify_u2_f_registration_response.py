...
class TestV2VerifyU2FRegistrationResponse(unittest.TestCase):
    """V2VerifyU2FRegistrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2VerifyU2FRegistrationResponse:
        """Test V2VerifyU2FRegistrationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2VerifyU2FRegistrationResponse`
        """
        model = V2VerifyU2FRegistrationResponse()
        if include_optional:
    ...
    def testV2VerifyU2FRegistrationResponse(self):
        """Test V2VerifyU2FRegistrationResponse"""
