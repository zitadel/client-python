...
class TestV2SetInstanceFeaturesResponse(unittest.TestCase):
    """V2SetInstanceFeaturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2SetInstanceFeaturesResponse:
        """Test V2SetInstanceFeaturesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2SetInstanceFeaturesResponse`
        """
        model = V2SetInstanceFeaturesResponse()
        if include_optional:
    ...
    def testV2SetInstanceFeaturesResponse(self):
        """Test V2SetInstanceFeaturesResponse"""
