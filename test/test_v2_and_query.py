...
class TestV2AndQuery(unittest.TestCase):
    """V2AndQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AndQuery:
        """Test V2AndQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AndQuery`
        """
        model = V2AndQuery()
        if include_optional:
            return V2AndQuery(
