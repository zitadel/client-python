...
class TestV2GetSystemFeaturesResponse(unittest.TestCase):
    """V2GetSystemFeaturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2GetSystemFeaturesResponse:
        """Test V2GetSystemFeaturesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2GetSystemFeaturesResponse`
        """
        model = V2GetSystemFeaturesResponse()
        if include_optional:
    ...
    def testV2GetSystemFeaturesResponse(self):
        """Test V2GetSystemFeaturesResponse"""
