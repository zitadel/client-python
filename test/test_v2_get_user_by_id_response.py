...
class TestV2GetUserByIDResponse(unittest.TestCase):
    """V2GetUserByIDResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2GetUserByIDResponse:
        """Test V2GetUserByIDResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2GetUserByIDResponse`
        """
        model = V2GetUserByIDResponse()
        if include_optional:
            return V2GetUserByIDResponse(
                ...
                user = zitadel_client.models.v2_user.v2User(
    ...
    def testV2GetUserByIDResponse(self):
        """Test V2GetUserByIDResponse"""
