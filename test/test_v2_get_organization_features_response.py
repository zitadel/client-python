...
class TestV2GetOrganizationFeaturesResponse(unittest.TestCase):
    """V2GetOrganizationFeaturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2GetOrganizationFeaturesResponse:
        """Test V2GetOrganizationFeaturesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2GetOrganizationFeaturesResponse`
        """
        model = V2GetOrganizationFeaturesResponse()
        if include_optional:
    ...
    def testV2GetOrganizationFeaturesResponse(self):
        """Test V2GetOrganizationFeaturesResponse"""
