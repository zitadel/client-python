...
class TestV2OrQuery(unittest.TestCase):
    """V2OrQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2OrQuery:
        """Test V2OrQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2OrQuery`
        """
        model = V2OrQuery()
        if include_optional:
            return V2OrQuery(
