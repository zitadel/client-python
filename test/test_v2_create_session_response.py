...
class TestV2CreateSessionResponse(unittest.TestCase):
    """V2CreateSessionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2CreateSessionResponse:
        """Test V2CreateSessionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2CreateSessionResponse`
        """
        model = V2CreateSessionResponse()
        if include_optional:
    ...
    def testV2CreateSessionResponse(self):
        """Test V2CreateSessionResponse"""
