...
class TestV2ResetInstanceFeaturesResponse(unittest.TestCase):
    """V2ResetInstanceFeaturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ResetInstanceFeaturesResponse:
        """Test V2ResetInstanceFeaturesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ResetInstanceFeaturesResponse`
        """
        model = V2ResetInstanceFeaturesResponse()
        if include_optional:
    ...
    def testV2ResetInstanceFeaturesResponse(self):
        """Test V2ResetInstanceFeaturesResponse"""
