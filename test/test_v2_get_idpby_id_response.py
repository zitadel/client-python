...
class TestV2GetIDPByIDResponse(unittest.TestCase):
    """V2GetIDPByIDResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2GetIDPByIDResponse:
        """Test V2GetIDPByIDResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2GetIDPByIDResponse`
        """
        model = V2GetIDPByIDResponse()
        if include_optional:
            return V2GetIDPByIDResponse(
                idp = zitadel_client.models.v2_idp.v2IDP(
    ...
    def testV2GetIDPByIDResponse(self):
        """Test V2GetIDPByIDResponse"""
