...
class TestV2ListUsersRequest(unittest.TestCase):
    """V2ListUsersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ListUsersRequest:
        """Test V2ListUsersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ListUsersRequest`
        """
        model = V2ListUsersRequest()
        if include_optional:
            return V2ListUsersRequest(
    ...
    def testV2ListUsersRequest(self):
        """Test V2ListUsersRequest"""
