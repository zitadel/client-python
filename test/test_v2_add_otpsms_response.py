...
class TestV2AddOTPSMSResponse(unittest.TestCase):
    """V2AddOTPSMSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AddOTPSMSResponse:
        ...
        # uncomment below to create an instance of `V2AddOTPSMSResponse`
        """
        model = V2AddOTPSMSResponse()
        if include_optional:
    ...
    def testV2AddOTPSMSResponse(self):
        """Test V2AddOTPSMSResponse"""
