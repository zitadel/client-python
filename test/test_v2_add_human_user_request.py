...
class TestV2AddHumanUserRequest(unittest.TestCase):
    """V2AddHumanUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AddHumanUserRequest:
        """Test V2AddHumanUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AddHumanUserRequest`
        """
        model = V2AddHumanUserRequest()
        if include_optional:
            return V2AddHumanUserRequest(
    ...
    def testV2AddHumanUserRequest(self):
        """Test V2AddHumanUserRequest"""
